...
def CrossEntropyLossDerivative(y_hat: np.ndarray, features: np.ndarray, targets: np.ndarray) -> np.ndarray:
...
def HuberLossDerivative(y_hat: np.ndarray, features: np.ndarray, targets: np.ndarray) -> np.ndarray:
