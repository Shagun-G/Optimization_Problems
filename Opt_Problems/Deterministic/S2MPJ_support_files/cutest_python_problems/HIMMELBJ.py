...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        iv = ix_['X2,1']
        self.A[ig,iv] = float(-7.69)+self.A[ig,iv]
        iv = ix_['X3,1']
        self.A[ig,iv] = float(-11.52)+self.A[ig,iv]
        iv = ix_['X4,1']
        self.A[ig,iv] = float(-36.60)+self.A[ig,iv]
        iv = ix_['X1,2']
        self.A[ig,iv] = float(-10.94)+self.A[ig,iv]
        iv = ix_['X8,2']
        self.A[ig,iv] = float(2.5966)+self.A[ig,iv]
        iv = ix_['X9,2']
        self.A[ig,iv] = float(-39.39)+self.A[ig,iv]
        iv = ix_['X10,2']
        self.A[ig,iv] = float(-21.35)+self.A[ig,iv]
        iv = ix_['X11,2']
        self.A[ig,iv] = float(-32.84)+self.A[ig,iv]
        iv = ix_['X12,2']
        self.A[ig,iv] = float(6.26)+self.A[ig,iv]
        iv = ix_['X1,3']
        self.A[ig,iv] = float(10.45)+self.A[ig,iv]
        iv = ix_['X3,3']
        self.A[ig,iv] = float(-0.5)+self.A[ig,iv]
        iv = ix_['X7,3']
        self.A[ig,iv] = float(2.2435)+self.A[ig,iv]
        iv = ix_['X9,3']
        self.A[ig,iv] = float(-39.39)+self.A[ig,iv]
        iv = ix_['X10,3']
        self.A[ig,iv] = float(-21.49)+self.A[ig,iv]
        iv = ix_['X11,3']
        self.A[ig,iv] = float(-32.84)+self.A[ig,iv]
        iv = ix_['X12,3']
        self.A[ig,iv] = float(6.12)+self.A[ig,iv]
        iv = ix_['X15,3']
        self.A[ig,iv] = float(-1.9028)+self.A[ig,iv]
        iv = ix_['X16,3']
        self.A[ig,iv] = float(-2.8889)+self.A[ig,iv]
        iv = ix_['X17,3']
        self.A[ig,iv] = float(-3.3622)+self.A[ig,iv]
        iv = ix_['X18,3']
        self.A[ig,iv] = float(-7.4854)+self.A[ig,iv]
        iv = ix_['X1,4']
        self.A[ig,iv] = float(-15.639)+self.A[ig,iv]
        iv = ix_['X3,4']
        self.A[ig,iv] = float(21.81)+self.A[ig,iv]
        iv = ix_['X1,5']
        self.A[ig,iv] = float(-16.79)+self.A[ig,iv]
        iv = ix_['X3,5']
        self.A[ig,iv] = float(18.9779)+self.A[ig,iv]
        iv = ix_['X2,6']
        self.A[ig,iv] = float(11.959)+self.A[ig,iv]
        iv = ix_['X2,7']
        self.A[ig,iv] = float(12.899)+self.A[ig,iv]
