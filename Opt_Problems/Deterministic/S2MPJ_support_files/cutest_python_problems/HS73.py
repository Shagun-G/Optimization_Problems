...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        iv = ix_['X1']
        self.A[ig,iv] = float(24.55)+self.A[ig,iv]
        iv = ix_['X2']
        self.A[ig,iv] = float(26.75)+self.A[ig,iv]
        iv = ix_['X3']
        self.A[ig,iv] = float(39.0)+self.A[ig,iv]
        iv = ix_['X4']
        self.A[ig,iv] = float(40.50)+self.A[ig,iv]
        ...
        iv = ix_['X3']
        self.A[ig,iv] = float(11.1)+self.A[ig,iv]
        iv = ix_['X4']
        ...
        iv = ix_['X2']
        self.A[ig,iv] = float(11.9)+self.A[ig,iv]
        iv = ix_['X3']
        self.A[ig,iv] = float(41.8)+self.A[ig,iv]
        iv = ix_['X4']
        self.A[ig,iv] = float(52.1)+self.A[ig,iv]
