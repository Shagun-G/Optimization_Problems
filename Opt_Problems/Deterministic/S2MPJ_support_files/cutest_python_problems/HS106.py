...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        iv = ix_['X4']
        self.A[ig,iv] = float(-0.0025)+self.A[ig,iv]
        iv = ix_['X6']
        self.A[ig,iv] = float(-0.0025)+self.A[ig,iv]
        ...
        iv = ix_['X4']
        self.A[ig,iv] = float(-833.33252)+self.A[ig,iv]
        iv = ix_['X1']
        ...
        iv = ix_['X5']
        self.A[ig,iv] = float(-1250.0)+self.A[ig,iv]
        iv = ix_['X4']
        self.A[ig,iv] = float(1250.0)+self.A[ig,iv]
        ...
        iv = ix_['X5']
        self.A[ig,iv] = float(2500.0)+self.A[ig,iv]
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        self.n   = len(ix_)
        ngrp   = len(ig_)
