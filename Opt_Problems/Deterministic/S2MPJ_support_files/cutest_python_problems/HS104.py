...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        iv = ix_['X1']
        self.A[ig,iv] = float(-1.0e+0)+self.A[ig,iv]
        iv = ix_['X2']
        self.A[ig,iv] = float(-1.0e+0)+self.A[ig,iv]
        ...
        iv = ix_['X1']
        self.A[ig,iv] = float(1.0e-1)+self.A[ig,iv]
        ...
        vname = 'X1'
        [iv,ix_] = s2mpj_nlx(self,vname,ix_,1,1.0e-1,1.0e+1,None)
