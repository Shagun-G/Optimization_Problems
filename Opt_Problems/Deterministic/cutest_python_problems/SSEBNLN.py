...
class SSEBNLN(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        [iv, ix_, _] = s2mpj_ii(
            "V" + str(int(v_["0"])) + "," + str(int(v_["HOURS"])), ix_
        )
        self.xnames = arrset(
            self.xnames, iv, "V" + str(int(v_["0"])) + "," + str(int(v_["HOURS"]))
        )
        [iv, ix_, _] = s2mpj_ii(
            "R" + str(int(v_["0"])) + "," + str(int(v_["HOURS"])), ix_
        )
        self.xnames = arrset(
            self.xnames, iv, "R" + str(int(v_["0"])) + "," + str(int(v_["HOURS"]))
        )
        ...
        for ID in range(int(v_["1"]), int(v_["DAYS"]) + 1):
            ...
            irA = np.append(irA, [ig])
            icA = np.append(
                icA, [ix_["V" + str(int(v_["P"])) + "," + str(int(v_["HOURS"]))]]
            )
            valA = np.append(valA, float(-1.0))
            [ig, ig_, _] = s2mpj_ii("H" + str(ID) + "," + str(int(v_["1"])), ig_)
            gtype = arrset(gtype, ig, "==")
        ...
        for ID in range(int(v_["1"]), int(v_["DAYS"]) + 1):
            ...
            irA = np.append(irA, [ig])
            icA = np.append(
                icA, [ix_["R" + str(int(v_["P"])) + "," + str(int(v_["HOURS"]))]]
            )
            valA = np.append(valA, float(-1.0))
            [ig, ig_, _] = s2mpj_ii("R" + str(ID) + "," + str(int(v_["1"])), ig_)
            gtype = arrset(gtype, ig, "==")
        ...
        for ID in range(int(v_["1"]), int(v_["DAYS"]) + 1):
            ...
            for IH in range(int(v_["1"]), int(v_["HOURS"]) + 1):
                self.gconst = arrset(
                    self.gconst, ig_["R" + str(ID) + "," + str(IH)], float(v_["0.01Z"])
                )
        for ID in range(int(v_["1"]), int(v_["DAYS"]) + 1):
            for IH in range(int(v_["1"]), int(v_["HOURS"]) + 1):
                self.gconst = arrset(
                    self.gconst,
                    ig_["D" + str(ID) + "," + str(IH)],
                    float(v_["D" + str(ID) + "," + str(IH)]),
                )
        # %%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xlower = np.zeros((self.n, 1))
        self.xupper = np.full((self.n, 1), float("inf"))
        self.xlower[ix_["V" + str(int(v_["0"])) + "," + str(int(v_["HOURS"]))]] = (
            240000.0
        )
        self.xupper[ix_["V" + str(int(v_["0"])) + "," + str(int(v_["HOURS"]))]] = (
            240000.0
        )
        ...
        if "V" + str(int(v_["0"])) + "," + str(int(v_["HOURS"])) in ix_:
            self.x0[ix_["V" + str(int(v_["0"])) + "," + str(int(v_["HOURS"]))]] = float(
                240000.0
            )
        else:
            self.y0 = arrset(
                ...
                findfirst(
                    self.congrps,
                    lambda x: x
                    == ig_["V" + str(int(v_["0"])) + "," + str(int(v_["HOURS"]))],
                ),
                float(240000.0),
            )
        if "R" + str(int(v_["0"])) + "," + str(int(v_["HOURS"])) in ix_:
            self.x0[ix_["R" + str(int(v_["0"])) + "," + str(int(v_["HOURS"]))]] = float(
                3500.0
            )
        else:
            self.y0 = arrset(
                ...
                findfirst(
                    self.congrps,
                    lambda x: x
                    == ig_["R" + str(int(v_["0"])) + "," + str(int(v_["HOURS"]))],
                ),
                float(3500.0),
            )
        for ID in range(int(v_["1"]), int(v_["DAYS"]) + 1):
            for IH in range(int(v_["1"]), int(v_["HOURS"]) + 1):
                if "P1" + str(ID) + "," + str(IH) in ix_:
                    ...
                    self.y0 = arrset(
                        ...
                        findfirst(
                            self.congrps,
                            lambda x: x == ig_["P1" + str(ID) + "," + str(IH)],
                        ),
                        float(70.0),
                    )
                if "P2" + str(ID) + "," + str(IH) in ix_:
                    ...
                    self.y0 = arrset(
                        ...
                        findfirst(
                            self.congrps,
                            lambda x: x == ig_["P2" + str(ID) + "," + str(IH)],
                        ),
                        float(90.0),
                    )
                if "QH" + str(ID) + "," + str(IH) in ix_:
                    ...
                    self.y0 = arrset(
                        ...
                        findfirst(
                            self.congrps,
                            lambda x: x == ig_["QH" + str(ID) + "," + str(IH)],
                        ),
                        float(25.0),
                    )
                if "QP" + str(ID) + "," + str(IH) in ix_:
                    ...
                    self.y0 = arrset(
                        ...
                        findfirst(
                            self.congrps,
                            lambda x: x == ig_["QP" + str(ID) + "," + str(IH)],
                        ),
                        float(225.0),
                    )
                if "V" + str(ID) + "," + str(IH) in ix_:
                    ...
                    self.y0 = arrset(
                        ...
                        findfirst(
                            self.congrps,
                            lambda x: x == ig_["V" + str(ID) + "," + str(IH)],
                        ),
                        float(240000.0),
                    )
                if "R" + str(ID) + "," + str(IH) in ix_:
                    ...
                    self.y0 = arrset(
                        ...
                        findfirst(
                            self.congrps,
                            lambda x: x == ig_["R" + str(ID) + "," + str(IH)],
                        ),
                        float(3500),
                    )
        pass
        ...
        for D in range(int(v_["1"]), int(v_["DAYS"]) + 1):
            for H in range(int(v_["1"]), int(v_["HOURS"]) + 1):
                ...
                self.grelt = loaset(
                    self.grelt, ig, posel, ie_["P" + str(D) + "," + str(H)]
                )
