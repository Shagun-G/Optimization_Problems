...
class HS111(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        for I in range(int(v_["1"]), int(v_["N"]) + 1):
            ...
            [iv, ix_] = s2mpj_nlx(
                self, vname, ix_, 1, float(-100.0), float(100.0), float(-2.3)
            )
    ...
    def eOBJ(self, nargout, *args):
        ...
        if nargout > 1:
            try:
                ...
                dim = len(EV_)
            g_ = np.zeros(dim)
            g_[0] = E1 * (self.elpar[iel_][0] + EV_[0] - np.log(SUM)) + E1 * (
                1.0e0 - E1 / SUM
            )
            g_[1] = -E1 * E2 / SUM
            g_[2] = -E1 * E3 / SUM
            ...
            if nargout > 2:
                H_ = np.zeros((10, 10))
                H_[0, 0] = (
                    E1 * (self.elpar[iel_][0] + EV_[0] - np.log(SUM))
                    + E1 * (1.0e0 - E1 / SUM)
                    + E1 * (1.0e0 - E1 / SUM)
                    + E1 * (-E1 / SUM)
                    + E1 * (E1**2 / SUM**2)
                )
                H_[0, 1] = (-1.0e0 + E1 / SUM) * E1 * E2 / SUM
                H_[1, 0] = H_[0, 1]
                H_[1, 1] = (-1.0e0 + E2 / SUM) * E1 * E2 / SUM
                H_[0, 2] = (-1.0e0 + E1 / SUM) * E1 * E3 / SUM
                H_[2, 0] = H_[0, 2]
                H_[1, 2] = E1 * E2 * E3 / SUM**2
                H_[2, 1] = H_[1, 2]
                H_[2, 2] = (-1.0e0 + E3 / SUM) * E1 * E3 / SUM
                H_[0, 3] = (-1.0e0 + E1 / SUM) * E1 * E4 / SUM
                H_[3, 0] = H_[0, 3]
                H_[1, 3] = E1 * E2 * E4 / SUM**2
                H_[3, 1] = H_[1, 3]
                H_[2, 3] = E1 * E3 * E4 / SUM**2
                H_[3, 2] = H_[2, 3]
                H_[3, 3] = (-1.0e0 + E4 / SUM) * E1 * E4 / SUM
                H_[0, 4] = (-1.0e0 + E1 / SUM) * E1 * E5 / SUM
                H_[4, 0] = H_[0, 4]
                ...
                H_[4, 3] = H_[3, 4]
                H_[4, 4] = (-1.0e0 + E5 / SUM) * E1 * E5 / SUM
                H_[0, 5] = (-1.0e0 + E1 / SUM) * E1 * E6 / SUM
                H_[5, 0] = H_[0, 5]
                ...
                H_[5, 4] = H_[4, 5]
                H_[5, 5] = (-1.0e0 + E6 / SUM) * E1 * E6 / SUM
                H_[0, 6] = (-1.0e0 + E1 / SUM) * E1 * E7 / SUM
                H_[6, 0] = H_[0, 6]
                ...
                H_[6, 5] = H_[5, 6]
                H_[6, 6] = (-1.0e0 + E7 / SUM) * E1 * E7 / SUM
                H_[0, 7] = (-1.0e0 + E1 / SUM) * E1 * E8 / SUM
                H_[7, 0] = H_[0, 7]
                ...
                H_[7, 6] = H_[6, 7]
                H_[7, 7] = (-1.0e0 + E8 / SUM) * E1 * E8 / SUM
                H_[0, 8] = (-1.0e0 + E1 / SUM) * E1 * E9 / SUM
                H_[8, 0] = H_[0, 8]
                ...
                H_[8, 7] = H_[7, 8]
                H_[8, 8] = (-1.0e0 + E9 / SUM) * E1 * E9 / SUM
                H_[0, 9] = (-1.0e0 + E1 / SUM) * E1 * E10 / SUM
                H_[9, 0] = H_[0, 9]
                ...
                H_[9, 8] = H_[8, 9]
                H_[9, 9] = (-1.0e0 + E10 / SUM) * E1 * E10 / SUM
        if nargout == 1:
            return f_
        elif nargout == 2:
            return f_, g_
