    ...
    def __init__(self, *args):
        ...
        for J in range(int(v_["1"]), int(v_["NBAR"]) + 1):
            ...
            for I in range(int(v_["1"]), int(v_["NDIM"]) + 1):
                v_["RG" + str(I) + "," + str(J)] = (
                    v_["GAMMA" + str(J)] * v_["R" + str(I) + "," + str(J)]
                )
                for K in range(int(v_["1"]), int(v_["NDIM"]) + 1):
                    v_["RR" + str(I) + "," + str(J) + "," + str(K)] = (
                        v_["RG" + str(I) + "," + str(J)]
                        * v_["R" + str(K) + "," + str(J)]
                    )
        # %%%%%%%%%%%%%%%%%%%  VARIABLES %%%%%%%%%%%%%%%%%%%%
        ...
        for K in range(int(v_["1"]), int(v_["NDIM"]) + 1):
            self.gconst = arrset(
                self.gconst, ig_["EQUIL" + str(K)], float(v_["P" + str(K)])
            )
        for J in range(int(v_["1"]), int(v_["NBAR"]) + 1):
            self.gconst = arrset(
                self.gconst, ig_["STRES" + str(J)], float(v_["STRUP" + str(J)])
            )
        # %%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        for I in range(int(v_["1"]), int(v_["NDIM"]) + 1):
            for J in range(int(v_["1"]), int(v_["NBAR"]) + 1):
                for K in range(int(v_["1"]), int(v_["NDIM"]) + 1):
                    ...
                    self.grelt = loaset(
                        self.grelt, ig, posel, ie_["UX" + str(I) + "," + str(J)]
                    )
