...
class RES(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        self.x0[ix_["NU"]] = float(2.2079e01)
        self.x0[ix_["D"]] = float(1.0000e-01)
        self.x0[ix_["P"]] = float(6.5268e-01)
        self.x0[ix_["E"]] = float(5.5268e-01)
        self.x0[ix_["P0"]] = float(6.5887e02)
        self.x0[ix_["G"]] = float(6.5887e04)
        self.x0[ix_["DM"]] = float(6.7120)
        self.x0[ix_["FR"]] = float(1.5000e-01)
        self.x0[ix_["TOLIM"]] = float(1.0000e02)
        self.x0[ix_["TOBLIM"]] = float(1.0000e02)
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_ = {}
        elftv = []
    ...
    def en111d2(self, nargout, *args):
        ...
        if nargout > 1:
            ...
            if nargout > 2:
                ...
                H_[3, 2] = H_[2, 3]
                H_[3, 3] = (6.0 * EV_[0] * EV_[1] * EV_[2]) / (
                    self.efpar[0] * EV_[3] ** 4
                )
        if nargout == 1:
            return f_
        elif nargout == 2:
