...
class DEMBO7(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        if "X1" in ix_:
            ...
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["X1"]), float(0.8)
            )
        if "X2" in ix_:
            self.x0[ix_["X2"]] = float(0.83)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X2"])[0], float(0.83)
            )
        if "X3" in ix_:
            self.x0[ix_["X3"]] = float(0.85)
        else:
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["X3"]), float(0.85)
            )
        if "X4" in ix_:
            self.x0[ix_["X4"]] = float(0.87)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X4"])[0], float(0.87)
            )
        if "X5" in ix_:
            self.x0[ix_["X5"]] = float(0.90)
        else:
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["X5"]), float(0.90)
            )
        if "X6" in ix_:
            self.x0[ix_["X6"]] = float(0.10)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X6"])[0], float(0.10)
            )
        if "X7" in ix_:
            self.x0[ix_["X7"]] = float(0.12)
        else:
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["X7"]), float(0.12)
            )
        if "X8" in ix_:
            self.x0[ix_["X8"]] = float(0.19)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X8"])[0], float(0.19)
            )
        if "X9" in ix_:
            self.x0[ix_["X9"]] = float(0.25)
        else:
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["X9"]), float(0.25)
            )
        if "X10" in ix_:
            self.x0[ix_["X10"]] = float(0.29)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X10"])[0], float(0.29)
            )
        if "X11" in ix_:
        ...
        if "X12" in ix_:
            ...
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X12"])[0], float(13.1)
            )
        if "X13" in ix_:
            self.x0[ix_["X13"]] = float(71.8)
        else:
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["X13"]), float(71.8)
            )
        if "X14" in ix_:
            self.x0[ix_["X14"]] = float(640.0)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X14"])[0], float(640.0)
            )
        if "X15" in ix_:
        ...
        if "X16" in ix_:
            ...
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X16"])[0], float(5.7)
            )
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_ = {}
        elftv = []
