...
class HS87(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        self.gconst = arrset(self.gconst, ig_["C1"], float(-3.0e2))
        self.gconst = arrset(self.gconst, ig_["C4"], float(-2.0e2))
        # %%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        if "X2" in ix_:
            ...
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X2"])[0], float(196.3186)
            )
        if "X3" in ix_:
        ...
        if "X4" in ix_:
            ...
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X4"])[0], float(420.0)
            )
        if "X5" in ix_:
        ...
        if "X6" in ix_:
            ...
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X6"])[0], float(0.153292)
            )
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_ = {}
        elftv = []
