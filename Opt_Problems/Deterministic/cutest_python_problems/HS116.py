...
class HS116(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        if "X1" in ix_:
            ...
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["X1"]), float(0.5)
            )
        if "X2" in ix_:
            self.x0[ix_["X2"]] = float(0.8)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X2"])[0], float(0.8)
            )
        if "X3" in ix_:
            self.x0[ix_["X3"]] = float(0.9)
        else:
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["X3"]), float(0.9)
            )
        if "X4" in ix_:
            self.x0[ix_["X4"]] = float(0.1)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X4"])[0], float(0.1)
            )
        if "X5" in ix_:
            self.x0[ix_["X5"]] = float(0.14)
        else:
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["X5"]), float(0.14)
            )
        if "X6" in ix_:
            self.x0[ix_["X6"]] = float(0.5)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X6"])[0], float(0.5)
            )
        if "X7" in ix_:
            self.x0[ix_["X7"]] = float(489.0)
        else:
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["X7"]), float(489.0)
            )
        if "X8" in ix_:
            self.x0[ix_["X8"]] = float(80.0)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X8"])[0], float(80.0)
            )
        if "X9" in ix_:
            self.x0[ix_["X9"]] = float(650.0)
        else:
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["X9"]), float(650.0)
            )
        if "X10" in ix_:
            self.x0[ix_["X10"]] = float(450.0)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X10"])[0], float(450.0)
            )
        if "X11" in ix_:
        ...
        if "X12" in ix_:
            ...
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X12"])[0], float(150.0)
            )
        if "X13" in ix_:
