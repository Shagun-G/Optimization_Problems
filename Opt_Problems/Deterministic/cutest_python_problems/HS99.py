...
class HS99(CUTEst_problem):
    ...
    def eQ8T(self, nargout, *args):
        ...
        Q2 = (
            ...
            * self.efpar[7]
            * self.efpar[7]
            * (self.efpar[0] * np.sin(EV_[0]) - self.efpar[14])
        )
        Q3 = (
            0.5
            * self.efpar[8]
            * self.efpar[8]
            * (self.efpar[1] * np.sin(EV_[1]) - self.efpar[14])
            + self.efpar[8] * S2
            + Q2
        )
        Q4 = (
            ...
            * self.efpar[9]
            * self.efpar[9]
            * (self.efpar[2] * np.sin(EV_[2]) - self.efpar[14])
            + self.efpar[9] * S3
            + Q3
        )
        Q5 = (
            ...
            * self.efpar[10]
            * self.efpar[10]
            * (self.efpar[3] * np.sin(EV_[3]) - self.efpar[14])
            + self.efpar[10] * S4
            + Q4
        )
        Q6 = (
            ...
            * self.efpar[11]
            * self.efpar[11]
            * (self.efpar[4] * np.sin(EV_[4]) - self.efpar[14])
            + self.efpar[11] * S5
            + Q5
        )
        Q7 = (
            ...
            * self.efpar[12]
            * self.efpar[12]
            * (self.efpar[5] * np.sin(EV_[5]) - self.efpar[14])
            + self.efpar[12] * S6
            + Q6
        )
        f_ = (
            ...
            * self.efpar[13]
            * self.efpar[13]
            * (self.efpar[6] * np.sin(EV_[6]) - self.efpar[14])
            + self.efpar[13] * S7
            + Q7
        )
        if not isinstance(f_, float):
        ...
        if nargout > 1:
            ...
            g_ = np.zeros(dim)
            g_[0] = (
                0.5 * self.efpar[7] * self.efpar[7] * self.efpar[0] * np.cos(EV_[0])
                + (
                    self.efpar[13]
                    + self.efpar[12]
                    + self.efpar[11]
            ...
            g_[1] = (
                0.5 * self.efpar[8] * self.efpar[8] * self.efpar[1] * np.cos(EV_[1])
                + (
                    self.efpar[13]
                    + self.efpar[12]
                    + self.efpar[11]
            ...
            g_[2] = (
                0.5 * self.efpar[9] * self.efpar[9] * self.efpar[2] * np.cos(EV_[2])
                + (self.efpar[13] + self.efpar[12] + self.efpar[11] + self.efpar[10])
                * DSD3
            )
            g_[3] = (
                0.5 * self.efpar[10] * self.efpar[10] * self.efpar[3] * np.cos(EV_[3])
                + (self.efpar[13] + self.efpar[12] + self.efpar[11]) * DSD4
            )
            g_[4] = (
                0.5 * self.efpar[11] * self.efpar[11] * self.efpar[4] * np.cos(EV_[4])
                + (self.efpar[13] + self.efpar[12]) * DSD5
            )
            g_[5] = (
                0.5 * self.efpar[12] * self.efpar[12] * self.efpar[5] * np.cos(EV_[5])
                + self.efpar[13] * DSD6
            )
            g_[6] = (
                0.5 * self.efpar[13] * self.efpar[13] * self.efpar[6] * np.cos(EV_[6])
            )
            if nargout > 2:
                H_ = np.zeros((7, 7))
                H_[0, 0] = (
