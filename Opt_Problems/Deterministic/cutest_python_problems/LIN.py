...
class LIN(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        for I in range(int(v_["1"]), int(v_["C"]) + 1):
            self.gconst = arrset(
                self.gconst, ig_["MB" + str(I)], float(v_["INIT" + str(I)])
            )
        v_["ZERO"] = 0.0
        v_["ONE"] = 1.0
        for I in range(int(v_["1"]), int(v_["C"]) + 1):
        ...
        for I in range(int(v_["1"]), int(v_["C"]) + 1):
            for J in range(int(v_["1"]), int(v_["C"]) + 1):
                v_["M" + str(I) + "," + str(J)] = (
                    v_["G" + str(I) + "," + str(J)] * v_["TAU" + str(I) + "," + str(J)]
                )
        # %%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xlower = np.full((self.n, 1), 1.0e-12)
        self.xupper = np.full((self.n, 1), +float("inf"))
        self.xupper[ix_["X" + str(int(v_["1"])) + "," + str(int(v_["1"]))]] = v_[
            "INIT1"
        ]
        self.xupper[ix_["X" + str(int(v_["1"])) + "," + str(int(v_["2"]))]] = v_[
            "INIT1"
        ]
        self.xupper[ix_["X" + str(int(v_["2"])) + "," + str(int(v_["1"]))]] = v_[
            "INIT2"
        ]
        self.xupper[ix_["X" + str(int(v_["2"])) + "," + str(int(v_["2"]))]] = v_[
            "INIT2"
        ]
        # %%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        ...
        for K in range(int(v_["1"]), int(v_["P"]) + 1):
            ...
            [iv, ix_] = s2mpj_nlx(self, vname, ix_, 1, float(1.0e-12), None, None)
            ...
            self.elpar = loaset(
                ...
                ie,
                posep[0],
                float(v_["G" + str(int(v_["1"])) + "," + str(int(v_["1"]))]),
            )
            ename = "A" + str(int(v_["1"])) + "," + str(K)
            [ie, ie_, _] = s2mpj_ii(ename, ie_)
            ...
            self.elpar = loaset(
                ...
                ie,
                posep[0],
                float(v_["G" + str(int(v_["1"])) + "," + str(int(v_["2"]))]),
            )
            ename = "A" + str(int(v_["1"])) + "," + str(K)
            [ie, ie_, _] = s2mpj_ii(ename, ie_)
            ...
            self.elpar = loaset(
                ...
                ie,
                posep[0],
                float(v_["G" + str(int(v_["2"])) + "," + str(int(v_["1"]))]),
            )
            ename = "A" + str(int(v_["1"])) + "," + str(K)
            [ie, ie_, _] = s2mpj_ii(ename, ie_)
            ...
            self.elpar = loaset(
                ...
                ie,
                posep[0],
                float(v_["G" + str(int(v_["2"])) + "," + str(int(v_["2"]))]),
            )
            ename = "A" + str(int(v_["1"])) + "," + str(K)
            [ie, ie_, _] = s2mpj_ii(ename, ie_)
            ...
            self.elpar = loaset(
                ...
                ie,
                posep[0],
                float(v_["M" + str(int(v_["1"])) + "," + str(int(v_["1"]))]),
            )
            ename = "A" + str(int(v_["1"])) + "," + str(K)
            [ie, ie_, _] = s2mpj_ii(ename, ie_)
            ...
            self.elpar = loaset(
                ...
                ie,
                posep[0],
                float(v_["M" + str(int(v_["1"])) + "," + str(int(v_["2"]))]),
            )
            ename = "A" + str(int(v_["1"])) + "," + str(K)
            [ie, ie_, _] = s2mpj_ii(ename, ie_)
            ...
            self.elpar = loaset(
                ...
                ie,
                posep[0],
                float(v_["M" + str(int(v_["2"])) + "," + str(int(v_["1"]))]),
            )
            ename = "A" + str(int(v_["1"])) + "," + str(K)
            [ie, ie_, _] = s2mpj_ii(ename, ie_)
            ...
            self.elpar = loaset(
                ...
                ie,
                posep[0],
                float(v_["M" + str(int(v_["2"])) + "," + str(int(v_["2"]))]),
            )
        ...
        for K in range(int(v_["1"]), int(v_["P"]) + 1):
            ...
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["A" + str(int(v_["1"])) + "," + str(K)]
            )
            nlc = np.union1d(nlc, np.array([ig]))
            self.grelw = loaset(self.grelw, ig, posel, 1.0)
            posel = posel + 1
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["A" + str(int(v_["2"])) + "," + str(K)]
            )
            self.grelw = loaset(self.grelw, ig, posel, 1.0)
            for I in range(int(v_["1"]), int(v_["C"]) + 1):
                ig = ig_["OBJ"]
                posel = len(self.grelt[ig])
                self.grelt = loaset(
                    self.grelt, ig, posel, ie_["B" + str(I) + "," + str(K)]
                )
                nlc = np.union1d(nlc, np.array([ig]))
                self.grelw = loaset(self.grelw, ig, posel, 1.0)
                posel = len(self.grelt[ig])
                self.grelt = loaset(
                    self.grelt, ig, posel, ie_["C" + str(I) + "," + str(K)]
                )
                nlc = np.union1d(nlc, np.array([ig]))
