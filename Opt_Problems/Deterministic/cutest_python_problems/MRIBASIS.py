...
class MRIBASIS(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        for i in range(int(v_["1"]), int(v_["3"]) + 1):
            for j in range(int(v_["1"]), int(v_["2"]) + 1):
                for k in range(int(v_["1"]), int(v_["Lm"]) + 1):
                    [iv, ix_, _] = s2mpj_ii(
                        "L" + str(i) + "," + str(j) + "," + str(k), ix_
                    )
                    self.xnames = arrset(
                        self.xnames, iv, "L" + str(i) + "," + str(j) + "," + str(k)
                    )
        # %%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        ...
        for i in range(int(v_["1"]), int(v_["3"]) + 1):
            for j in range(int(v_["1"]), int(v_["2"]) + 1):
                for k in range(int(v_["1"]), int(v_["Lm-"]) + 1):
                    ...
                    v_["2k-"] = -1 + v_["2k"]
                    [ig, ig_, _] = s2mpj_ii(
                        "SU" + str(i) + "," + str(j) + "," + str(k), ig_
                    )
                    gtype = arrset(gtype, ig, "<=")
                    cnames = arrset(
                        cnames, ig, "SU" + str(i) + "," + str(j) + "," + str(k)
                    )
                    irA = np.append(irA, [ig])
                    icA = np.append(
                        icA,
                        [ix_["L" + str(i) + "," + str(j) + "," + str(int(v_["k+"]))]],
                    )
                    valA = np.append(valA, float(1))
                    irA = np.append(irA, [ig])
                    icA = np.append(
                        icA, [ix_["L" + str(i) + "," + str(j) + "," + str(k)]]
                    )
                    valA = np.append(valA, float(-1))
                    irA = np.append(irA, [ig])
                    ...
                    irA = np.append(irA, [ig])
                    icA = np.append(
                        icA, [ix_["X" + str(j) + "," + str(int(v_["2k-"]))]]
                    )
                    valA = np.append(valA, float(v_["k1"]))
                    [ig, ig_, _] = s2mpj_ii(
                        "SL" + str(i) + "," + str(j) + "," + str(k), ig_
                    )
                    gtype = arrset(gtype, ig, ">=")
                    cnames = arrset(
                        cnames, ig, "SL" + str(i) + "," + str(j) + "," + str(k)
                    )
                    irA = np.append(irA, [ig])
                    icA = np.append(
                        icA,
        ...
        for i in range(int(v_["1"]), int(v_["3"]) + 1):
            for k in range(int(v_["2"]), int(v_["Lm-"]) + 1):
                ...
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["L" + str(i) + "," + str(int(v_["2"])) + "," + str(k)]]
                )
                valA = np.append(
                    valA, float(v_["S" + str(int(v_["3"])) + "," + str(i)])
                )
        for i in range(int(v_["1"]), int(v_["3"]) + 1):
        ...
        for i in range(int(v_["1"]), int(v_["3"]) + 1):
            self.gconst = arrset(
                self.gconst, ig_["c2const" + str(i)], float(v_["Opmr" + str(i)])
            )
        ...
        for j in range(int(v_["1"]), int(v_["2"]) + 1):
            ...
            self.xlower[ix_["X" + str(j) + "," + str(int(v_["1"]))]] = v_[
                "xlo" + str(j)
            ]
            self.xupper[ix_["X" + str(j) + "," + str(int(v_["1"]))]] = v_[
                "xlo" + str(j)
            ]
        self.xlower[ix_["X" + str(int(v_["1"])) + "," + str(int(v_["xm"]))]] = v_[
            "xup1"
        ]
        self.xupper[ix_["X" + str(int(v_["1"])) + "," + str(int(v_["xm"]))]] = v_[
            "xup1"
        ]
        ...
        for i in range(int(v_["1"]), int(v_["3"]) + 1):
            for j in range(int(v_["1"]), int(v_["2"]) + 1):
                for k in range(int(v_["2"]), int(v_["Lm-"]) + 1):
                    self.xlower[ix_["L" + str(i) + "," + str(j) + "," + str(k)]] = v_[
                        "-k2"
                    ]
                    self.xupper[ix_["L" + str(i) + "," + str(j) + "," + str(k)]] = v_[
                        "k2"
                    ]
                self.xlower[
                    ix_["L" + str(i) + "," + str(j) + "," + str(int(v_["1"]))]
                ] = v_["Llo" + str(j) + "," + str(i)]
                self.xupper[
                    ix_["L" + str(i) + "," + str(j) + "," + str(int(v_["1"]))]
                ] = v_["Llo" + str(j) + "," + str(i)]
            self.xlower[
                ix_["L" + str(i) + "," + str(int(v_["1"])) + "," + str(int(v_["Lm"]))]
            ] = v_["Lup" + str(int(v_["1"])) + "," + str(i)]
            self.xupper[
                ix_["L" + str(i) + "," + str(int(v_["1"])) + "," + str(int(v_["Lm"]))]
            ] = v_["Lup" + str(int(v_["1"])) + "," + str(i)]
            self.xlower[
                ix_["L" + str(i) + "," + str(int(v_["2"])) + "," + str(int(v_["Lm"]))]
            ] = v_["-k2"]
            self.xupper[
                ix_["L" + str(i) + "," + str(int(v_["2"])) + "," + str(int(v_["Lm"]))]
            ] = v_["k2"]
        ...
        for k in range(int(v_["1"]), int(v_["xm-"]) + 1):
            ...
            v_["k+"] = 1 + k
            self.x0[ix_["X" + str(int(v_["1"])) + "," + str(int(v_["k+"]))]] = float(
                v_["strtv1"]
            )
            self.x0[ix_["X" + str(int(v_["2"])) + "," + str(int(v_["k+"]))]] = float(
                v_["strtv2"]
            )
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_ = {}
            ...
            for i in range(int(v_["1"]), int(v_["3"]) + 1):
                for k in range(int(v_["1"]), int(v_["Lm-"]) + 1):
                    ...
                    self.grelt = loaset(
                        ...
                        ig,
                        posel,
                        ie_["e1" + str(i) + "," + str(int(v_["2"])) + "," + str(k)],
                    )
                    nlc = np.union1d(nlc, np.array([ig]))
                    self.grelw = loaset(
                        self.grelw,
                ...
                for k in range(int(v_["1"]), int(v_["Lm-2"]) + 1):
                    ...
                    self.grelt = loaset(
                        ...
                        ig,
                        posel,
                        ie_["e2" + str(i) + "," + str(int(v_["2"])) + "," + str(k)],
                    )
                    nlc = np.union1d(nlc, np.array([ig]))
                    self.grelw = loaset(
                        self.grelw,
            ...
            for i in range(int(v_["1"]), int(v_["3"]) + 1):
                for k in range(int(v_["1"]), int(v_["Lm-"]) + 1):
                    ...
                    self.grelt = loaset(
                        ...
                        ig,
                        posel,
                        ie_["e1" + str(i) + "," + str(int(v_["1"])) + "," + str(k)],
                    )
                    nlc = np.union1d(nlc, np.array([ig]))
                    self.grelw = loaset(
                        self.grelw, ig, posel, float(v_["-S" + str(j) + "," + str(i)])
                    )
                    posel = len(self.grelt[ig])
                    self.grelt = loaset(
                        self.grelt,
                ...
                for k in range(int(v_["1"]), int(v_["Lm-2"]) + 1):
                    ...
                    self.grelt = loaset(
                        ...
                        ig,
                        posel,
                        ie_["e2" + str(i) + "," + str(int(v_["1"])) + "," + str(k)],
                    )
                    nlc = np.union1d(nlc, np.array([ig]))
                    self.grelw = loaset(
                        self.grelw, ig, posel, float(v_["-S" + str(j) + "," + str(i)])
            ...
            for i in range(int(v_["1"]), int(v_["3"]) + 1):
                for k in range(int(v_["1"]), int(v_["Lm-"]) + 1):
                    ...
                    self.grelt = loaset(
                        ...
                        ig,
                        posel,
                        ie_["e3" + str(i) + "," + str(int(v_["1"])) + "," + str(k)],
                    )
                    nlc = np.union1d(nlc, np.array([ig]))
                    self.grelw = loaset(
                        self.grelw, ig, posel, float(v_["S" + str(j) + "," + str(i)])
                    ...
                    self.grelt = loaset(
                        ...
                        ig,
                        posel,
                        ie_["e5" + str(i) + "," + str(int(v_["1"])) + "," + str(k)],
                    )
                    nlc = np.union1d(nlc, np.array([ig]))
                    self.grelw = loaset(
                        self.grelw, ig, posel, float(v_["S" + str(j) + "," + str(i)])
                    ...
                    self.grelt = loaset(
                        ...
                        ig,
                        posel,
                        ie_["e3" + str(i) + "," + str(int(v_["2"])) + "," + str(k)],
                    )
                    nlc = np.union1d(nlc, np.array([ig]))
                    self.grelw = loaset(
                        self.grelw, ig, posel, float(v_["-S" + str(j) + "," + str(i)])
                    ...
                    self.grelt = loaset(
                        ...
                        ig,
                        posel,
                        ie_["e5" + str(i) + "," + str(int(v_["2"])) + "," + str(k)],
                    )
                    nlc = np.union1d(nlc, np.array([ig]))
                    self.grelw = loaset(
                        self.grelw, ig, posel, float(v_["-S" + str(j) + "," + str(i)])
                ...
                for k in range(int(v_["1"]), int(v_["Lm-2"]) + 1):
                    ...
                    self.grelt = loaset(
                        ...
                        ig,
                        posel,
                        ie_["e4" + str(i) + "," + str(int(v_["1"])) + "," + str(k)],
                    )
                    nlc = np.union1d(nlc, np.array([ig]))
                    self.grelw = loaset(
                        self.grelw, ig, posel, float(v_["2S" + str(j) + "," + str(i)])
                    )
                    posel = len(self.grelt[ig])
                    self.grelt = loaset(
                        self.grelt,
                        ig,
                        posel,
                        ie_["e4" + str(i) + "," + str(int(v_["2"])) + "," + str(k)],
                    )
                    nlc = np.union1d(nlc, np.array([ig]))
                    self.grelw = loaset(
                        self.grelw, ig, posel, float(v_["-2S" + str(j) + "," + str(i)])
    ...
    def euvw1(self, nargout, *args):
        ...
        f_ = (
            ...
            * (EV_[1] - EV_[2])
            * (
                (d14 + self.elpar[iel_][0]) * EV_[1]
                + (d14 - self.elpar[iel_][0]) * EV_[2]
            )
        )
        if not isinstance(f_, float):
            f_ = f_.item()
        if nargout > 1:
            ...
            g_[1] = (
                EV_[0]
                * 2.0e0
                * (EV_[1] * (d14 + self.elpar[iel_][0]) - self.elpar[iel_][0] * EV_[2])
            )
            g_[2] = (
                EV_[0]
                * 2.0e0
                * (-EV_[2] * (d14 - self.elpar[iel_][0]) - self.elpar[iel_][0] * EV_[1])
            )
            if nargout > 2:
                H_ = np.zeros((3, 3))
                H_[0, 1] = 2.0e0 * (
