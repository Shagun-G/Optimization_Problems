...
class QR3D(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        self.gconst = arrset(
            self.gconst,
            ig_["F" + str(int(v_["1"])) + "," + str(int(v_["1"]))],
            float(v_["A" + str(int(v_["1"])) + "," + str(int(v_["1"]))]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["F" + str(int(v_["1"])) + "," + str(int(v_["2"]))],
            float(v_["A" + str(int(v_["1"])) + "," + str(int(v_["2"]))]),
        )
        for I in range(int(v_["2"]), int(v_["M-1"]) + 1):
            v_["I-1"] = -1 + I
            v_["I+1"] = 1 + I
            self.gconst = arrset(
                self.gconst,
                ig_["F" + str(I) + "," + str(int(v_["I-1"]))],
                float(v_["A" + str(I) + "," + str(int(v_["I-1"]))]),
            )
            self.gconst = arrset(
                self.gconst,
                ig_["F" + str(I) + "," + str(I)],
                float(v_["A" + str(I) + "," + str(I)]),
            )
            self.gconst = arrset(
                self.gconst,
                ig_["F" + str(I) + "," + str(int(v_["I+1"]))],
        ...
        self.gconst = arrset(
            self.gconst,
            ig_["F" + str(int(v_["M"])) + "," + str(int(v_["M-1"]))],
            float(v_["A" + str(int(v_["M"])) + "," + str(int(v_["M-1"]))]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["F" + str(int(v_["M"])) + "," + str(int(v_["M"]))],
        ...
        for I in range(int(v_["1"]), int(v_["M-1"]) + 1):
            v_["I+1"] = 1 + I
            self.x0[ix_["R" + str(I) + "," + str(I)]] = float(
                v_["A" + str(I) + "," + str(I)]
            )
            self.x0[ix_["R" + str(I) + "," + str(int(v_["I+1"]))]] = float(
                v_["A" + str(I) + "," + str(int(v_["I+1"]))]
            )
        self.x0[ix_["R" + str(int(v_["M"])) + "," + str(int(v_["M"]))]] = float(
            v_["A" + str(int(v_["M"])) + "," + str(int(v_["M"]))]
        )
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_ = {}
        elftv = []
