...
class NET1(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        irA = np.append(irA, [ig])
        icA = np.append(icA, [ix_["CBV18"]])
        valA = np.append(valA, float(1.00000e04))
        irA = np.append(irA, [ig])
        icA = np.append(icA, [ix_["CFL18"]])
        valA = np.append(valA, float(-1.00000000))
        ...
        irA = np.append(irA, [ig])
        icA = np.append(icA, [ix_["SBV21"]])
        valA = np.append(valA, float(-3.00000e03))
        irA = np.append(irA, [ig])
        icA = np.append(icA, [ix_["SFL21"]])
        valA = np.append(valA, float(1.00000000))
        ...
        irA = np.append(irA, [ig])
        icA = np.append(icA, [ix_["SBV22"]])
        valA = np.append(valA, float(-1.06000e02))
        irA = np.append(irA, [ig])
        icA = np.append(icA, [ix_["SFL22"]])
        valA = np.append(valA, float(1.00000000))
        ...
        irA = np.append(irA, [ig])
        icA = np.append(icA, [ix_["CBV18"]])
        valA = np.append(valA, float(-4.72000e02))
        ...
        irA = np.append(irA, [ig])
        icA = np.append(icA, [ix_["CBV19"]])
        valA = np.append(valA, float(-3.45000e02))
        ...
        irA = np.append(irA, [ig])
        icA = np.append(icA, [ix_["CBV20"]])
        valA = np.append(valA, float(-5.75000e02))
        ...
        for i in range(int(v_["1"]), int(v_["NPIP"]) + 1):
            ...
            self.gscale = arrset(self.gscale, ig, float(1.00000e03))
        ...
        self.gconst = arrset(self.gconst, ig_["MBE9"], float(3.72060e02))
        self.gconst = arrset(self.gconst, ig_["MBE10"], float(47.17000000))
        self.gconst = arrset(self.gconst, ig_["MBE11"], float(1.60060e02))
        self.gconst = arrset(self.gconst, ig_["MBE12"], float(4.25060e02))
        self.gconst = arrset(self.gconst, ig_["MBE13"], float(5.30000e02))
        ...
        self.gconst = arrset(self.gconst, ig_["MBE17"], float(4.92900e02))
        self.gconst = arrset(self.gconst, ig_["MBE20"], float(4.64280e02))
        self.gconst = arrset(self.gconst, ig_["MBE21"], float(1.48400e02))
        self.gconst = arrset(self.gconst, ig_["CLF18"], float(1.00000e04))
        self.gconst = arrset(self.gconst, ig_["CLF19"], float(1.00000e04))
        self.gconst = arrset(self.gconst, ig_["CLF20"], float(1.00000e04))
        self.gconst = arrset(self.gconst, ig_["HPCON18"], float(2.07000e04))
        self.gconst = arrset(self.gconst, ig_["HPCON19"], float(2.07000e04))
        self.gconst = arrset(self.gconst, ig_["HPCON20"], float(4.14000e04))
        # %%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xlower = np.full((self.n, 1), -float("Inf"))
        self.xupper = np.full((self.n, 1), +float("Inf"))
        self.xlower[ix_["SFL21"]] = 0.00000
        self.xupper[ix_["SFL21"]] = 3.00000e03
        self.xlower[ix_["SFL22"]] = 0.00000
        self.xupper[ix_["SFL22"]] = 1.06000e02
        self.xlower[ix_["NOP1"]] = 5.00000e02
        self.xupper[ix_["NOP1"]] = 1.01500e03
        self.xlower[ix_["NOP2"]] = 5.00000e02
        self.xupper[ix_["NOP2"]] = 1.10000e03
        self.xlower[ix_["NOP3"]] = 5.00000e02
        self.xupper[ix_["NOP3"]] = 9.72000e02
        self.xlower[ix_["NOP4"]] = 5.00000e02
        self.xupper[ix_["NOP4"]] = 1.10000e03
        self.xlower[ix_["NOP5"]] = 5.00000e02
        self.xupper[ix_["NOP5"]] = 1.10000e03
        self.xlower[ix_["NOP6"]] = 5.00000e02
        self.xupper[ix_["NOP6"]] = 8.45000e02
        self.xlower[ix_["NOP7"]] = 5.00000e02
        self.xupper[ix_["NOP7"]] = 1.10000e03
        self.xlower[ix_["NOP8"]] = 5.00000e02
        self.xupper[ix_["NOP8"]] = 1.07500e03
        self.xlower[ix_["NOP9"]] = 5.00000e02
        self.xupper[ix_["NOP9"]] = 1.10000e03
        self.xlower[ix_["NOP10"]] = 5.00000e02
        self.xupper[ix_["NOP10"]] = 1.10000e03
        self.xlower[ix_["NOP11"]] = 5.00000e02
        self.xupper[ix_["NOP11"]] = 1.10000e03
        self.xlower[ix_["NOP12"]] = 5.00000e02
        self.xupper[ix_["NOP12"]] = 1.10000e03
        self.xlower[ix_["NOP13"]] = 5.80000e02
        self.xupper[ix_["NOP13"]] = 1.10000e03
        self.xlower[ix_["NOP14"]] = 5.00000e02
        self.xupper[ix_["NOP14"]] = 1.10000e03
        self.xlower[ix_["NOP15"]] = 5.00000e02
        self.xupper[ix_["NOP15"]] = 1.10000e03
        self.xlower[ix_["NOP16"]] = 5.00000e02
        self.xupper[ix_["NOP16"]] = 1.10000e03
        self.xlower[ix_["NOP17"]] = 5.00000e02
        self.xupper[ix_["NOP17"]] = 1.10000e03
        self.xlower[ix_["NOP18"]] = 5.00000e02
        self.xupper[ix_["NOP18"]] = 1.10000e03
        self.xlower[ix_["NOP19"]] = 5.00000e02
        self.xupper[ix_["NOP19"]] = 1.10000e03
        self.xlower[ix_["NOP20"]] = 5.00000e02
        self.xupper[ix_["NOP20"]] = 1.10000e03
        self.xlower[ix_["NOP21"]] = 5.00000e02
        self.xupper[ix_["NOP21"]] = 1.10000e03
        ...
        # %%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        self.x0 = np.full((self.n, 1), float(5.00000e02))
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_ = {}
        elftv = []
        ...
        vname = "NOP1"
        [iv, ix_] = s2mpj_nlx(self, vname, ix_, 1, None, None, float(5.00000e02))
    ...
    def eA0PANHAN(self, nargout, *args):
        ...
        if A0FGT0 == 0:
            A0HFLO = (
                ...
                * (A0FLEX - 1.0e0)
                * self.elpar[iel_][0]
                * np.absolute(EV_[2]) ** (A0FLEX - 2.0e0)
            )
        f_ = (
            EV_[0] * EV_[0]
            - EV_[1] * EV_[1]
            - self.elpar[iel_][0] * EV_[2] * np.absolute(EV_[2]) ** (A0FLEX - 1.0e0)
        )
        ...
        if nargout > 1:
            ...
            g_[0] = 2.0e0 * EV_[0]
            g_[2] = (
                -self.elpar[iel_][0] * A0FLEX * np.absolute(EV_[2]) ** (A0FLEX - 1.0e0)
            )
            if nargout > 2:
                H_ = np.zeros((3, 3))
                H_[1, 1] = -2.0e0
