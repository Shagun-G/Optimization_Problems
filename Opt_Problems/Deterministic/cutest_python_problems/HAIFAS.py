...
class HAIFAS(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(1.00000e01))
        v_["J"] = 2
        v_["L"] = 2
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["E" + str(int(v_["L"]))])
        ...
        self.grelt = loaset(self.grelt, ig, posel, ie_["E" + str(int(v_["L"]))])
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(self.grelw, ig, posel, float(4.00000e01))
        v_["J"] = 3
        v_["L"] = 6
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["E" + str(int(v_["L"]))])
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(self.grelw, ig, posel, float(-8.00000e01))
        v_["J"] = 3
        v_["L"] = 7
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["E" + str(int(v_["L"]))])
