...
class ECKERLE4(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        if "B1" in ix_:
            ...
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["B1"]), float(1.0)
            )
        if "B2" in ix_:
        ...
        if "B3" in ix_:
            ...
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["B3"]), float(500.0)
            )
        pass
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_ = {}
    ...
    def eE(self, nargout, *args):
        ...
        if nargout > 1:
            ...
            if nargout > 2:
                ...
                H_[2, 0] = H_[0, 2]
                H_[1, 1] = (
                    2.0 * V1E / V23 - 5.0 * V1E * V3MX2 / V25 + V1E * V3MX**4 / V27
                )
