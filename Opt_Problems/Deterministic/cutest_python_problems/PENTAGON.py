...
class PENTAGON(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        if "Y1" in ix_:
            ...
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["Y1"]), float(0.0)
            )
        if "X2" in ix_:
        ...
        if "Y2" in ix_:
            ...
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["Y2"]), float(-1.0)
            )
        if "X3" in ix_:
        ...
        if "Y3" in ix_:
            ...
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["Y3"]), float(1.0)
            )
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_ = {}
        elftv = []
