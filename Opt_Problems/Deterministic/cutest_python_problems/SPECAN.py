...
class SPECAN(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        for p in range(int(v_["1"]), int(v_["K"]) + 1):
            for j in range(int(v_["1"]), int(v_["N"]) + 1):
                self.xlower[ix_["X" + str(p) + "," + str(j)]] = v_[
                    "LOWER" + str(p) + "," + str(j)
                ]
                self.xupper[ix_["X" + str(p) + "," + str(j)]] = v_[
                    "UPPER" + str(p) + "," + str(j)
                ]
        # %%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        ...
        for p in range(int(v_["1"]), int(v_["K"]) + 1):
            for j in range(int(v_["1"]), int(v_["N"]) + 1):
                self.x0[ix_["X" + str(p) + "," + str(j)]] = float(
                    v_["START" + str(p) + "," + str(j)]
                )
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_ = {}
        elftv = []
        ...
        for p in range(int(v_["1"]), int(v_["K"]) + 1):
            for I in range(int(v_["1"]), int(v_["M"]) + 1):
                ...
                self.grelt = loaset(
                    self.grelt, ig, posel, ie_["E" + str(p) + "," + str(I)]
                )
