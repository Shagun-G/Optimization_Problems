...
class DALLASS(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        valA = np.append(valA, float(-6.38400e02))
        irA = np.append(irA, [ig])
        icA = np.append(icA, [ix_["X43"]])
        valA = np.append(valA, float(-6.33000e02))
        irA = np.append(irA, [ig])
        icA = np.append(icA, [ix_["X44"]])
        valA = np.append(valA, float(-5.54500e02))
        irA = np.append(irA, [ig])
        icA = np.append(icA, [ix_["X45"]])
        valA = np.append(valA, float(-5.05000e02))
        irA = np.append(irA, [ig])
        icA = np.append(icA, [ix_["X46"]])
        valA = np.append(valA, float(-4.36900e02))
        ...
        self.gconst = arrset(self.gconst, ig_["N31"], float(-1.01960e01))
        # %%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xlower = np.full((self.n, 1), -2.00000e02)
        self.xupper = np.full((self.n, 1), 2.00000e02)
        self.xlower[ix_["X1"]] = 0.00000
        self.xupper[ix_["X1"]] = 2.11673e01
        self.xlower[ix_["X2"]] = 0.00000
        self.xupper[ix_["X2"]] = 4.37635e01
        self.xlower[ix_["X3"]] = 0.00000
        self.xupper[ix_["X3"]] = 3.28255e01
        self.xlower[ix_["X19"]] = 0.00000
        self.xupper[ix_["X19"]] = 2.20120e01
        self.xlower[ix_["X21"]] = 0.00000
        self.xupper[ix_["X21"]] = 1.36703e01
        # %%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        self.x0 = np.full((self.n, 1), float(-2.00000e02))
        if "X1" in ix_:
            self.x0[ix_["X1"]] = float(2.11673e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X2" in ix_:
            self.x0[ix_["X2"]] = float(4.37635e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X2"])[0], float(4.37635e01)
            )
        if "X3" in ix_:
            self.x0[ix_["X3"]] = float(3.28255e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X4" in ix_:
            ...
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X4"])[0], float(1.42109e-14)
            )
        if "X5" in ix_:
            self.x0[ix_["X5"]] = float(1.68826e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X7" in ix_:
            self.x0[ix_["X7"]] = float(2.81745e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X7"])[0], float(2.81745e01)
            )
        if "X8" in ix_:
            self.x0[ix_["X8"]] = float(8.75603e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X9" in ix_:
            self.x0[ix_["X9"]] = float(-5.93858e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X9"])[0], float(-5.93858e01)
            )
        if "X10" in ix_:
            self.x0[ix_["X10"]] = float(-5.97888e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X11" in ix_:
            self.x0[ix_["X11"]] = float(1.83383e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X11"])[0], float(1.83383e02)
            )
        if "X13" in ix_:
            self.x0[ix_["X13"]] = float(-1.68331e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X15" in ix_:
            self.x0[ix_["X15"]] = float(2.00000e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X15"])[0], float(2.00000e02)
            )
        if "X16" in ix_:
        ...
        if "X17" in ix_:
            self.x0[ix_["X17"]] = float(2.00000e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X17"])[0], float(2.00000e02)
            )
        if "X18" in ix_:
            self.x0[ix_["X18"]] = float(-7.67574e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X19" in ix_:
            self.x0[ix_["X19"]] = float(2.20120e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X19"])[0], float(2.20120e01)
            )
        if "X20" in ix_:
            self.x0[ix_["X20"]] = float(1.36703e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X21" in ix_:
            self.x0[ix_["X21"]] = float(1.36703e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X21"])[0], float(1.36703e01)
            )
        if "X22" in ix_:
            self.x0[ix_["X22"]] = float(-1.98461e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X23" in ix_:
            self.x0[ix_["X23"]] = float(1.81531e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X23"])[0], float(1.81531e02)
            )
        if "X24" in ix_:
            self.x0[ix_["X24"]] = float(-1.93133e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X25" in ix_:
            self.x0[ix_["X25"]] = float(2.00000e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X25"])[0], float(2.00000e02)
            )
        if "X26" in ix_:
            self.x0[ix_["X26"]] = float(-1.98792e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X27" in ix_:
            ...
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X27"])[0], float(1.15500)
            )
        if "X28" in ix_:
        ...
        if "X29" in ix_:
            self.x0[ix_["X29"]] = float(2.00000e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X29"])[0], float(2.00000e02)
            )
        if "X30" in ix_:
        ...
        if "X32" in ix_:
            self.x0[ix_["X32"]] = float(-1.98843e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X32"])[0], float(-1.98843e01)
            )
        if "X33" in ix_:
            self.x0[ix_["X33"]] = float(1.78834e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X34" in ix_:
            self.x0[ix_["X34"]] = float(-1.79589e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X34"])[0], float(-1.79589e02)
            )
        if "X35" in ix_:
            self.x0[ix_["X35"]] = float(-1.98843e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X37" in ix_:
            self.x0[ix_["X37"]] = float(1.79589e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X37"])[0], float(1.79589e02)
            )
        if "X40" in ix_:
            self.x0[ix_["X40"]] = float(2.00000e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X41" in ix_:
            self.x0[ix_["X41"]] = float(2.00000e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X41"])[0], float(2.00000e02)
            )
        if "X42" in ix_:
            self.x0[ix_["X42"]] = float(9.87694e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X43" in ix_:
            self.x0[ix_["X43"]] = float(1.36703e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X43"])[0], float(1.36703e01)
            )
        if "X44" in ix_:
            self.x0[ix_["X44"]] = float(3.28255e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X45" in ix_:
            self.x0[ix_["X45"]] = float(4.37635e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X45"])[0], float(4.37635e01)
            )
        if "X46" in ix_:
            self.x0[ix_["X46"]] = float(-1.78833e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        self.elpar = loaset(self.elpar, ie, posep[0], float(4.48060e02))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(2.51200e02))
        ename = "E2"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        self.elftype = arrset(self.elftype, ie, "eT4")
        ielftype = arrset(ielftype, ie, iet_["eT4"])
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.91526e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(6.46300e01))
        ename = "E3"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        self.elftype = arrset(self.elftype, ie, "eT4")
        ielftype = arrset(ielftype, ie, iet_["eT4"])
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.07752e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(4.81400e01))
        ename = "E4"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(6.90000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(6.60000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.22000e02))
        ename = "E5"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eT1")
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.00000e02))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.00000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.00000e02))
        ename = "E6"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(6.63000e02))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(3.60000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.20000e02))
        ename = "E7"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eT1")
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.10000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(6.60000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.22000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(6.45000e02))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(3.00000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.20000e02))
        ename = "E9"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(7.40000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(6.60000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.22000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.00000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(6.60000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(9.50000e01))
        ename = "E11"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eT1")
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(8.00000e02))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.40000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.07000e02))
        ename = "E12"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eT1")
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.20000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(4.80000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.10000e02))
        ename = "E13"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eT1")
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(6.00000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(4.80000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.10000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(4.00000e02))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.40000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.00000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(4.00000e01))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(3.12200e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.30000e02))
        ename = "E16"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eT1")
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(4.50000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(6.60000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.22000e02))
        ...
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.10000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(2.40000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.10000e02))
        ename = "E18"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        ...
        self.elpar = loaset(self.elpar, ie, posep[0], float(4.80000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.18000e02))
        ename = "E19"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        self.elftype = arrset(self.elftype, ie, "eT4")
        ielftype = arrset(ielftype, ie, iet_["eT4"])
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(4.84530e02))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.12970e02))
        ename = "E20"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eT1")
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(2.60000e04))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(4.80000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.10000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.86880e02))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.60610e02))
        ename = "E22"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eT1")
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.20000e02))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(3.36100e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.30000e02))
        ename = "E23"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(4.60000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.40000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(9.50000e01))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.40000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.40000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(9.50000e01))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.60000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.20000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.10000e02))
        ename = "E26"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(3.30000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.20000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.10000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(2.20000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(2.40000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.24000e02))
        ename = "E28"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eT1")
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.00000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(2.40000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.10000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.90000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(2.40000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.13000e02))
        ename = "E30"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eT1")
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(2.80000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(2.40000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.13000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(2.70000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.20000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.10000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(3.10000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.40000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(9.50000e01))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(4.30000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(2.40000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.13000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.80000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(5.40000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.10000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.31000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(3.00000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.00000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(6.65000e02))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(3.60000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.20000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.10000e03))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(3.60000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.20000e02))
        ...
        self.elvar = loaset(self.elvar, ie, posev[0], iv)
        posep = np.where(elftp[ielftype[ie]] == "C1")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(3.23000e01))
        posep = np.where(elftp[ielftype[ie]] == "C2")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.00000e01))
        posep = np.where(elftp[ielftype[ie]] == "C3")[0]
        self.elpar = loaset(self.elpar, ie, posep[0], float(1.00000e02))
