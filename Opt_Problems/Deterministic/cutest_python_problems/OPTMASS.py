...
class OPTMASS(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        for J in range(int(v_["1"]), int(v_["2"]) + 1):
            ...
            self.xnames = arrset(
                self.xnames, iv, "X" + str(J) + "," + str(int(v_["N+1"]))
            )
            [iv, ix_, _] = s2mpj_ii("V" + str(J) + "," + str(int(v_["N+1"])), ix_)
            self.xnames = arrset(
                self.xnames, iv, "V" + str(J) + "," + str(int(v_["N+1"]))
            )
        # %%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        ...
        self.xlower[ix_["V" + str(int(v_["1"])) + "," + str(int(v_["0"]))]] = v_[
            "SPEED"
        ]
        self.xupper[ix_["V" + str(int(v_["1"])) + "," + str(int(v_["0"]))]] = v_[
            "SPEED"
        ]
        ...
        if "V" + str(int(v_["1"])) + "," + str(int(v_["0"])) in ix_:
            self.x0[ix_["V" + str(int(v_["1"])) + "," + str(int(v_["0"]))]] = float(
                v_["SPEED"]
            )
        else:
            self.y0 = arrset(
                ...
                findfirst(
                    self.congrps,
                    lambda x: x
                    == ig_["V" + str(int(v_["1"])) + "," + str(int(v_["0"]))],
                ),
                float(v_["SPEED"]),
            )
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        ...
        for I in range(int(v_["0"]), int(v_["N"]) + 1):
            ...
            posel = len(self.grelt[ig])
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["D" + str(int(v_["1"])) + "," + str(I)]
            )
            nlc = np.union1d(nlc, np.array([ig]))
            self.grelw = loaset(self.grelw, ig, posel, 1.0)
            posel = posel + 1
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["D" + str(int(v_["2"])) + "," + str(I)]
            )
            self.grelw = loaset(self.grelw, ig, posel, 1.0)
        # %%%%%%%%%%%%%%%%%% OBJECT BOUNDS %%%%%%%%%%%%%%%%%
        #    Solution
