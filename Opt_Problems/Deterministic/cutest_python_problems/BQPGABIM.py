...
class BQPGABIM(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(1.0624e03))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O   1  11"])
        self.grelw = loaset(self.grelw, ig, posel, float(-9.9819e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["D  11  11"])
        self.grelw = loaset(self.grelw, ig, posel, float(7.8331e02))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O   1  12"])
        self.grelw = loaset(self.grelw, ig, posel, float(-9.9709e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O  11  12"])
        self.grelw = loaset(self.grelw, ig, posel, float(1.0000e02))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(7.5507e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(-9.7537e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(8.9945e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O   2  30"])
        self.grelw = loaset(self.grelw, ig, posel, float(9.0300e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(6.4885e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(7.5197e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O   2  49"])
        self.grelw = loaset(self.grelw, ig, posel, float(-9.7167e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["D   3   3"])
        self.grelw = loaset(self.grelw, ig, posel, float(1.0624e03))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O   3  11"])
        self.grelw = loaset(self.grelw, ig, posel, float(8.1209e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O   3  20"])
        self.grelw = loaset(self.grelw, ig, posel, float(8.1463e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(-7.3536e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O   3  36"])
        self.grelw = loaset(self.grelw, ig, posel, float(-5.3119e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O   3  41"])
        self.grelw = loaset(self.grelw, ig, posel, float(-6.1506e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(7.9480e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O   3  50"])
        self.grelw = loaset(self.grelw, ig, posel, float(-9.7566e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(-1.8370e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O   4  41"])
        self.grelw = loaset(self.grelw, ig, posel, float(-2.1312e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(-2.3863e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(-1.7205e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(-1.9971e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(2.5757e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(-9.0289e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(-6.5144e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O   6  41"])
        self.grelw = loaset(self.grelw, ig, posel, float(-7.5509e01))
        posel = len(self.grelt[ig])
        ...
        self.grelw = loaset(self.grelw, ig, posel, float(2.9135e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O  10  20"])
        self.grelw = loaset(self.grelw, ig, posel, float(2.9241e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O  10  29"])
        self.grelw = loaset(self.grelw, ig, posel, float(-2.6379e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O  10  36"])
        self.grelw = loaset(self.grelw, ig, posel, float(-1.9046e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O  10  41"])
        self.grelw = loaset(self.grelw, ig, posel, float(-2.2065e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O  10  47"])
        self.grelw = loaset(self.grelw, ig, posel, float(7.5507e01))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt, ig, posel, ie_["O  41  47"])
        self.grelw = loaset(self.grelw, ig, posel, float(-2.9232e01))
        posel = len(self.grelt[ig])
