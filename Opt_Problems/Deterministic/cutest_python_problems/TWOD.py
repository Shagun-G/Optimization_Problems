    ...
    def __init__(self, *args):
        ...
        for I in range(int(v_["0"]), int(v_["N"]) + 1):
            for J in range(int(v_["0"]), int(v_["N"]) + 1):
                for K in range(int(v_["0"]), int(v_["M"]) + 1):
                    [iv, ix_, _] = s2mpj_ii(
                        "Y" + str(K) + "," + str(I) + "," + str(J), ix_
                    )
                    self.xnames = arrset(
                        self.xnames, iv, "Y" + str(K) + "," + str(I) + "," + str(J)
                    )
        ...
        for I in range(int(v_["1"]), int(v_["N1"]) + 1):
            ...
            for J in range(int(v_["1"]), int(v_["N1"]) + 1):
                ...
                for K in range(int(v_["0"]), int(v_["M1"]) + 1):
                    v_["K+"] = 1 + K
                    [ig, ig_, _] = s2mpj_ii(
                        "P" + str(K) + "," + str(I) + "," + str(J), ig_
                    )
                    gtype = arrset(gtype, ig, "==")
                    cnames = arrset(
                        cnames, ig, "P" + str(K) + "," + str(I) + "," + str(J)
                    )
                    irA = np.append(irA, [ig])
                    icA = np.append(
                        icA,
                        [ix_["Y" + str(int(v_["K+"])) + "," + str(I) + "," + str(J)]],
                    )
                    valA = np.append(valA, float(v_["1/DT+2/H2"]))
                    irA = np.append(irA, [ig])
                    icA = np.append(
                        icA, [ix_["Y" + str(K) + "," + str(I) + "," + str(J)]]
                    )
                    valA = np.append(valA, float(v_["-1/DT+2/H2"]))
                    irA = np.append(irA, [ig])
                    icA = np.append(
                        icA,
                        [ix_["Y" + str(K) + "," + str(I) + "," + str(int(v_["J-"]))]],
                    )
                    ...
                    icA = np.append(
                        icA,
                        [ix_["Y" + str(K) + "," + str(int(v_["I-"])) + "," + str(J)]],
                    )
                    valA = np.append(valA, float(v_["-.1/2H2"]))
                    irA = np.append(irA, [ig])
                    icA = np.append(
        ...
        for I in range(int(v_["1"]), int(v_["N1"]) + 1):
            for K in range(int(v_["1"]), int(v_["M"]) + 1):
                ...
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["Y" + str(K) + "," + str(I) + "," + str(int(v_["N2"]))]]
                )
                valA = np.append(valA, float(v_["1/2DY"]))
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["Y" + str(K) + "," + str(I) + "," + str(int(v_["N1"]))]]
                )
                valA = np.append(valA, float(v_["-2/DY"]))
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["Y" + str(K) + "," + str(I) + "," + str(int(v_["N"]))]]
                )
                ...
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["Y" + str(K) + "," + str(I) + "," + str(int(v_["2"]))]]
                )
                valA = np.append(valA, float(v_["1/2DY"]))
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["Y" + str(K) + "," + str(I) + "," + str(int(v_["1"]))]]
                )
                valA = np.append(valA, float(v_["-2/DY"]))
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["Y" + str(K) + "," + str(I) + "," + str(int(v_["0"]))]]
                )
                valA = np.append(valA, float(v_["3/2DY+1"]))
        for J in range(int(v_["1"]), int(v_["N1"]) + 1):
            for K in range(int(v_["1"]), int(v_["M"]) + 1):
                ...
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["Y" + str(K) + "," + str(int(v_["2"])) + "," + str(J)]]
                )
                valA = np.append(valA, float(v_["1/2DX"]))
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["Y" + str(K) + "," + str(int(v_["1"])) + "," + str(J)]]
                )
                valA = np.append(valA, float(v_["-2/DX"]))
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["Y" + str(K) + "," + str(int(v_["0"])) + "," + str(J)]]
                )
                ...
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["Y" + str(K) + "," + str(int(v_["N2"])) + "," + str(J)]]
                )
                valA = np.append(valA, float(v_["1/2DX"]))
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["Y" + str(K) + "," + str(int(v_["N1"])) + "," + str(J)]]
                )
                valA = np.append(valA, float(v_["-2/DX"]))
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["Y" + str(K) + "," + str(int(v_["N"])) + "," + str(J)]]
                )
                valA = np.append(valA, float(v_["3/2DX+1"]))
        # %%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        self.n = len(ix_)
        ...
        for I in range(int(v_["0"]), int(v_["N"]) + 1):
            for J in range(int(v_["0"]), int(v_["N"]) + 1):
                self.xlower[
                    ix_["Y" + str(int(v_["0"])) + "," + str(I) + "," + str(J)]
                ] = 0.0
                self.xupper[
                    ix_["Y" + str(int(v_["0"])) + "," + str(I) + "," + str(J)]
                ] = 0.0
        ...
        for J in range(int(v_["1"]), int(v_["N1"]) + 1):
            ...
            self.grelt = loaset(
                ...
                ig,
                posel,
                ie_["E" + str(int(v_["M"])) + "," + str(int(v_["0"])) + "," + str(J)],
            )
            nlc = np.union1d(nlc, np.array([ig]))
            ...
            self.grelt = loaset(
                ...
                ig,
                posel,
                ie_["E" + str(int(v_["M"])) + "," + str(int(v_["N"])) + "," + str(J)],
            )
            nlc = np.union1d(nlc, np.array([ig]))
            self.grelw = loaset(self.grelw, ig, posel, float(v_[".25DXDY"]))
            posel = len(self.grelt[ig])
            self.grelt = loaset(
                ...
                ig,
                posel,
                ie_["E" + str(int(v_["M"])) + "," + str(J) + "," + str(int(v_["0"]))],
            )
            nlc = np.union1d(nlc, np.array([ig]))
            self.grelw = loaset(self.grelw, ig, posel, float(v_[".25DXDY"]))
            posel = len(self.grelt[ig])
        ...
        for I in range(int(v_["1"]), int(v_["N1"]) + 1):
            for J in range(int(v_["1"]), int(v_["N1"]) + 1):
                ...
                self.grelt = loaset(
                    ...
                    ig,
                    posel,
                    ie_["E" + str(int(v_["M"])) + "," + str(I) + "," + str(J)],
                )
                nlc = np.union1d(nlc, np.array([ig]))
        ...
        for K in range(int(v_["1"]), int(v_["M1"]) + 1):
            for I in range(int(v_["1"]), int(v_["N1"]) + 1):
                ...
                posel = len(self.grelt[ig])
                self.grelt = loaset(
                    self.grelt, ig, posel, ie_["E" + str(K) + "," + str(I)]
                )
                nlc = np.union1d(nlc, np.array([ig]))
        ...
        for I in range(int(v_["1"]), int(v_["N1"]) + 1):
            ...
            posel = len(self.grelt[ig])
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["E" + str(int(v_["M"])) + "," + str(I)]
            )
            nlc = np.union1d(nlc, np.array([ig]))
