...
class VESUVIA(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        if "B1" in ix_:
            ...
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["B1"]), float(0.0)
            )
        if "B2" in ix_:
            self.x0[ix_["B2"]] = float(0.0)
        else:
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["B2"]), float(0.0)
            )
        if "B3" in ix_:
        ...
        if "B5" in ix_:
            self.x0[ix_["B5"]] = float(1.0e5)
        else:
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["B5"]), float(1.0e5)
            )
        if "B6" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["B6"]),
                float(0.0979798),
            )
        if "B7" in ix_:
        ...
        if "B8" in ix_:
            self.x0[ix_["B8"]] = float(1.0e5)
        else:
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["B8"]), float(1.0e5)
            )
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_ = {}
        elftv = []
