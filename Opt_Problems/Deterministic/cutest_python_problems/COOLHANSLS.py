    ...
    def __init__(self, *args):
        ...
        for K in range(int(v_["1"]), int(v_["N"]) + 1):
            for L in range(int(v_["1"]), int(v_["N"]) + 1):
                ...
                self.gconst = arrset(
                    self.gconst, ig_["G" + str(K) + "," + str(L)], float(v_["-C"])
                )
        # %%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
            ...
            for P in range(int(v_["1"]), int(v_["N"]) + 1):
                for M in range(int(v_["1"]), int(v_["N"]) + 1):
                    ...
                    self.grelt = loaset(
                        ...
                        ig,
                        posel,
                        ie_["E" + str(P) + "," + str(M) + "," + str(L)],
                    )
                    self.grelw = loaset(
                        self.grelw,
                        ig,
                        posel,
                        float(v_["A" + str(int(v_["1"])) + "," + str(P)]),
                    )
        for L in range(int(v_["1"]), int(v_["N"]) + 1):
            for P in range(int(v_["1"]), int(v_["N"]) + 1):
                for M in range(int(v_["1"]), int(v_["N"]) + 1):
