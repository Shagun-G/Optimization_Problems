...
class HIMMELBI(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        for I in range(int(v_["1"]), int(v_["5"]) + 1):
            self.gconst = arrset(
                self.gconst, ig_["CC" + str(I)], float(v_["C" + str(I)])
            )
        # %%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
