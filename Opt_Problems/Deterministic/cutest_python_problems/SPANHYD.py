...
class SPANHYD(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        self.gconst = arrset(self.gconst, ig_["N1"], float(-5.13800e01))
        self.gconst = arrset(self.gconst, ig_["N2"], float(-1.38400e01))
        self.gconst = arrset(self.gconst, ig_["N3"], float(-2.58000))
        self.gconst = arrset(self.gconst, ig_["N4"], float(-2.19100e01))
        self.gconst = arrset(self.gconst, ig_["N6"], float(-1.29700e01))
        self.gconst = arrset(self.gconst, ig_["N8"], float(-2.89000))
        self.gconst = arrset(self.gconst, ig_["N9"], float(-2.08400e01))
        self.gconst = arrset(self.gconst, ig_["N10"], float(-1.71400e01))
        self.gconst = arrset(self.gconst, ig_["N11"], float(-3.20600e01))
        self.gconst = arrset(self.gconst, ig_["N12"], float(-2.80000e-01))
        self.gconst = arrset(self.gconst, ig_["N13"], float(-4.20000))
        self.gconst = arrset(self.gconst, ig_["N14"], float(-4.83700e01))
        self.gconst = arrset(self.gconst, ig_["N16"], float(-1.81300e01))
        self.gconst = arrset(self.gconst, ig_["N18"], float(1.61000))
        self.gconst = arrset(self.gconst, ig_["N19"], float(-2.66000e01))
        self.gconst = arrset(self.gconst, ig_["N20"], float(-1.87600e01))
        self.gconst = arrset(self.gconst, ig_["N21"], float(-1.81300e01))
        self.gconst = arrset(self.gconst, ig_["N24"], float(-1.81300e01))
        ...
        self.gconst = arrset(self.gconst, ig_["N31"], float(6.08350e02))
        self.gconst = arrset(self.gconst, ig_["N32"], float(-4.62634e03))
        self.gconst = arrset(self.gconst, ig_["N33"], float(4.36300e03))
        # %%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xupper = np.full((self.n, 1), 3.02400e03)
        self.xlower = np.zeros((self.n, 1))
        self.xlower[ix_["X1"]] = 7.70000e01
        self.xupper[ix_["X1"]] = 7.70100e01
        self.xlower[ix_["X2"]] = 1.12452e03
        self.xupper[ix_["X2"]] = 1.12453e03
        self.xlower[ix_["X3"]] = 1.58000e02
        self.xupper[ix_["X3"]] = 1.58010e02
        self.xlower[ix_["X4"]] = 1.60000e01
        self.xupper[ix_["X4"]] = 1.60100e01
        self.xlower[ix_["X5"]] = 0.00000
        self.xupper[ix_["X5"]] = 0.00000
        self.xlower[ix_["X6"]] = 7.83650e02
        self.xupper[ix_["X6"]] = 7.83660e02
        self.xlower[ix_["X7"]] = 1.10000e01
        self.xupper[ix_["X7"]] = 1.10100e01
        self.xlower[ix_["X8"]] = 4.90000e01
        self.xupper[ix_["X8"]] = 4.90100e01
        self.xlower[ix_["X9"]] = 2.15517e03
        self.xupper[ix_["X9"]] = 2.15518e03
        self.xlower[ix_["X10"]] = 2.52000e02
        self.xupper[ix_["X10"]] = 2.52010e02
        self.xupper[ix_["X11"]] = 3.97840e02
        self.xupper[ix_["X12"]] = 2.22320e02
        self.xupper[ix_["X13"]] = 2.05630e02
        self.xupper[ix_["X14"]] = 2.05630e02
        self.xupper[ix_["X15"]] = 2.05630e02
        self.xupper[ix_["X16"]] = 1.24830e02
        self.xupper[ix_["X17"]] = 1.27010e02
        self.xupper[ix_["X18"]] = 6.10800e01
        self.xupper[ix_["X19"]] = 6.14840e02
        self.xupper[ix_["X20"]] = 7.78080e02
        self.xupper[ix_["X25"]] = 7.25760e03
        self.xupper[ix_["X26"]] = 1.20960e03
        self.xupper[ix_["X27"]] = 9.07200e02
        self.xupper[ix_["X28"]] = 7.25760e03
        self.xupper[ix_["X29"]] = 7.25760e03
        self.xlower[ix_["X30"]] = 7.70000e01
        self.xupper[ix_["X30"]] = 7.70000e01
        self.xlower[ix_["X31"]] = 4.03400e02
        self.xupper[ix_["X31"]] = 1.31200e03
        self.xlower[ix_["X32"]] = 1.58000e02
        self.xupper[ix_["X32"]] = 1.58000e02
        self.xlower[ix_["X33"]] = 1.60000e01
        self.xupper[ix_["X33"]] = 1.60000e01
        self.xlower[ix_["X34"]] = 0.00000
        self.xupper[ix_["X34"]] = 0.00000
        self.xlower[ix_["X35"]] = 5.02000e02
        self.xupper[ix_["X35"]] = 9.28460e02
        self.xlower[ix_["X36"]] = 1.10000e01
        self.xupper[ix_["X36"]] = 1.10000e01
        self.xlower[ix_["X37"]] = 4.90000e01
        self.xupper[ix_["X37"]] = 4.90000e01
        self.xlower[ix_["X38"]] = 9.15300e02
        self.xupper[ix_["X38"]] = 2.61160e03
        self.xlower[ix_["X39"]] = 2.52000e02
        self.xupper[ix_["X39"]] = 2.52000e02
        self.xupper[ix_["X40"]] = 3.97840e02
        self.xupper[ix_["X41"]] = 2.22320e02
        self.xupper[ix_["X42"]] = 2.05630e02
        self.xupper[ix_["X43"]] = 2.05630e02
        self.xupper[ix_["X44"]] = 2.05630e02
        self.xupper[ix_["X45"]] = 1.24830e02
        self.xupper[ix_["X46"]] = 1.27010e02
        self.xupper[ix_["X47"]] = 6.10800e01
        self.xupper[ix_["X48"]] = 6.14840e02
        self.xupper[ix_["X49"]] = 7.78080e02
        self.xupper[ix_["X54"]] = 7.25760e03
        self.xupper[ix_["X55"]] = 1.20960e03
        self.xupper[ix_["X56"]] = 9.07200e02
        self.xupper[ix_["X57"]] = 7.25760e03
        self.xupper[ix_["X58"]] = 7.25760e03
        self.xlower[ix_["X59"]] = 7.70000e01
        self.xupper[ix_["X59"]] = 7.70000e01
        self.xlower[ix_["X60"]] = 4.03400e02
        self.xupper[ix_["X60"]] = 1.31200e03
        self.xlower[ix_["X61"]] = 1.58000e02
        self.xupper[ix_["X61"]] = 1.58000e02
        self.xlower[ix_["X62"]] = 1.60000e01
        self.xupper[ix_["X62"]] = 1.60000e01
        self.xlower[ix_["X63"]] = 0.00000
        self.xupper[ix_["X63"]] = 0.00000
        self.xlower[ix_["X64"]] = 5.05640e02
        self.xupper[ix_["X64"]] = 9.28460e02
        self.xlower[ix_["X65"]] = 1.10000e01
        self.xupper[ix_["X65"]] = 1.10000e01
        self.xlower[ix_["X66"]] = 4.90000e01
        self.xupper[ix_["X66"]] = 4.90000e01
        self.xlower[ix_["X67"]] = 9.15300e02
        self.xupper[ix_["X67"]] = 2.61160e03
        self.xlower[ix_["X68"]] = 2.52000e02
        self.xupper[ix_["X68"]] = 2.52000e02
        self.xupper[ix_["X69"]] = 3.97840e02
        self.xupper[ix_["X70"]] = 2.22320e02
        self.xupper[ix_["X71"]] = 2.05630e02
        self.xupper[ix_["X72"]] = 2.05630e02
        self.xupper[ix_["X73"]] = 2.05630e02
        self.xupper[ix_["X74"]] = 1.24830e02
        self.xupper[ix_["X75"]] = 1.27010e02
        self.xupper[ix_["X76"]] = 6.10800e01
        self.xupper[ix_["X77"]] = 6.14840e02
        self.xupper[ix_["X78"]] = 7.78080e02
        self.xupper[ix_["X83"]] = 7.25760e03
        self.xupper[ix_["X84"]] = 1.20960e03
        self.xupper[ix_["X85"]] = 9.07200e02
        self.xupper[ix_["X86"]] = 7.25760e03
        self.xupper[ix_["X87"]] = 7.25760e03
        self.xlower[ix_["X88"]] = 7.70000e01
        self.xupper[ix_["X88"]] = 7.70100e01
        self.xlower[ix_["X89"]] = 1.10000e03
        self.xupper[ix_["X89"]] = 1.10001e03
        self.xlower[ix_["X90"]] = 1.58000e02
        self.xupper[ix_["X90"]] = 1.58010e02
        self.xlower[ix_["X91"]] = 1.60000e01
        self.xupper[ix_["X91"]] = 1.60100e01
        self.xlower[ix_["X92"]] = 0.00000
        self.xupper[ix_["X92"]] = 0.00000
        self.xlower[ix_["X93"]] = 7.00000e02
        self.xupper[ix_["X93"]] = 7.00010e02
        self.xlower[ix_["X94"]] = 1.10000e01
        self.xupper[ix_["X94"]] = 1.10100e01
        self.xlower[ix_["X95"]] = 4.90000e01
        self.xupper[ix_["X95"]] = 4.90100e01
        self.xlower[ix_["X96"]] = 2.00000e03
        self.xupper[ix_["X96"]] = 2.00001e03
        self.xlower[ix_["X97"]] = 2.52000e02
        self.xupper[ix_["X97"]] = 2.52010e02
        # %%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        self.x0 = np.full((self.n, 1), float(0.0))
        if "X1" in ix_:
            self.x0[ix_["X1"]] = float(7.70000e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X2" in ix_:
            self.x0[ix_["X2"]] = float(1.12452e03)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X2"])[0], float(1.12452e03)
            )
        if "X3" in ix_:
            self.x0[ix_["X3"]] = float(1.58000e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X4" in ix_:
            self.x0[ix_["X4"]] = float(1.60000e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X4"])[0], float(1.60000e01)
            )
        if "X6" in ix_:
            self.x0[ix_["X6"]] = float(7.83650e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X7" in ix_:
            self.x0[ix_["X7"]] = float(1.10000e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X7"])[0], float(1.10000e01)
            )
        if "X8" in ix_:
            self.x0[ix_["X8"]] = float(4.90000e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X9" in ix_:
            self.x0[ix_["X9"]] = float(2.15517e03)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X9"])[0], float(2.15517e03)
            )
        if "X10" in ix_:
            self.x0[ix_["X10"]] = float(2.52000e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X11" in ix_:
            self.x0[ix_["X11"]] = float(5.13800e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X11"])[0], float(5.13800e01)
            )
        if "X12" in ix_:
            self.x0[ix_["X12"]] = float(1.40210e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X13" in ix_:
            self.x0[ix_["X13"]] = float(1.42790e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X13"])[0], float(1.42790e02)
            )
        if "X14" in ix_:
            self.x0[ix_["X14"]] = float(2.19100e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X15" in ix_:
            self.x0[ix_["X15"]] = float(1.64700e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X15"])[0], float(1.64700e02)
            )
        if "X16" in ix_:
            self.x0[ix_["X16"]] = float(5.81900e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X17" in ix_:
            self.x0[ix_["X17"]] = float(5.81900e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X17"])[0], float(5.81900e01)
            )
        if "X18" in ix_:
            self.x0[ix_["X18"]] = float(6.10800e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X19" in ix_:
            self.x0[ix_["X19"]] = float(5.66430e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X19"])[0], float(5.66430e02)
            )
        if "X20" in ix_:
            self.x0[ix_["X20"]] = float(5.83570e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X30" in ix_:
            self.x0[ix_["X30"]] = float(7.70000e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X30"])[0], float(7.70000e01)
            )
        if "X31" in ix_:
            self.x0[ix_["X31"]] = float(1.04953e03)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X32" in ix_:
            self.x0[ix_["X32"]] = float(1.58000e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X32"])[0], float(1.58000e02)
            )
        if "X33" in ix_:
            self.x0[ix_["X33"]] = float(1.60000e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X35" in ix_:
            self.x0[ix_["X35"]] = float(7.38430e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X35"])[0], float(7.38430e02)
            )
        if "X36" in ix_:
            self.x0[ix_["X36"]] = float(1.10000e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X37" in ix_:
            self.x0[ix_["X37"]] = float(4.90000e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X37"])[0], float(4.90000e01)
            )
        if "X38" in ix_:
            self.x0[ix_["X38"]] = float(1.83536e03)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X39" in ix_:
            self.x0[ix_["X39"]] = float(2.52000e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X39"])[0], float(2.52000e02)
            )
        if "X40" in ix_:
            self.x0[ix_["X40"]] = float(3.20600e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X42" in ix_:
            ...
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X42"])[0], float(4.20000)
            )
        if "X43" in ix_:
            self.x0[ix_["X43"]] = float(4.83700e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X44" in ix_:
            self.x0[ix_["X44"]] = float(5.25700e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X44"])[0], float(5.25700e01)
            )
        if "X45" in ix_:
            self.x0[ix_["X45"]] = float(5.98500e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X46" in ix_:
            self.x0[ix_["X46"]] = float(5.98500e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X46"])[0], float(5.98500e01)
            )
        if "X47" in ix_:
            self.x0[ix_["X47"]] = float(5.82400e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X49" in ix_:
            self.x0[ix_["X49"]] = float(1.87600e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X49"])[0], float(1.87600e01)
            )
        if "X59" in ix_:
            self.x0[ix_["X59"]] = float(7.70000e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X60" in ix_:
            self.x0[ix_["X60"]] = float(1.08187e03)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X60"])[0], float(1.08187e03)
            )
        if "X61" in ix_:
            self.x0[ix_["X61"]] = float(1.58000e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X62" in ix_:
            self.x0[ix_["X62"]] = float(1.60000e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X62"])[0], float(1.60000e01)
            )
        if "X64" in ix_:
            self.x0[ix_["X64"]] = float(6.96710e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X65" in ix_:
            self.x0[ix_["X65"]] = float(1.10000e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X65"])[0], float(1.10000e01)
            )
        if "X66" in ix_:
            self.x0[ix_["X66"]] = float(4.90000e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X67" in ix_:
            self.x0[ix_["X67"]] = float(1.97277e03)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X67"])[0], float(1.97277e03)
            )
        if "X68" in ix_:
            self.x0[ix_["X68"]] = float(2.52000e02)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X69" in ix_:
            self.x0[ix_["X69"]] = float(1.81300e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X69"])[0], float(1.81300e01)
            )
        if "X72" in ix_:
            self.x0[ix_["X72"]] = float(1.81300e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X73" in ix_:
            self.x0[ix_["X73"]] = float(1.81300e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X73"])[0], float(1.81300e01)
            )
        if "X74" in ix_:
        ...
        if "X75" in ix_:
            ...
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X75"])[0], float(5.81000)
            )
        if "X78" in ix_:
        ...
        if "X88" in ix_:
            self.x0[ix_["X88"]] = float(7.70000e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X88"])[0], float(7.70000e01)
            )
        if "X89" in ix_:
            self.x0[ix_["X89"]] = float(1.10000e03)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X90" in ix_:
            self.x0[ix_["X90"]] = float(1.58000e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X90"])[0], float(1.58000e02)
            )
        if "X91" in ix_:
            self.x0[ix_["X91"]] = float(1.60000e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X93" in ix_:
            self.x0[ix_["X93"]] = float(7.00000e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X93"])[0], float(7.00000e02)
            )
        if "X94" in ix_:
            self.x0[ix_["X94"]] = float(1.10000e01)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X95" in ix_:
            self.x0[ix_["X95"]] = float(4.90000e01)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X95"])[0], float(4.90000e01)
            )
        if "X96" in ix_:
            self.x0[ix_["X96"]] = float(2.00000e03)
        else:
            self.y0 = arrset(
                self.y0,
        ...
        if "X97" in ix_:
            self.x0[ix_["X97"]] = float(2.52000e02)
        else:
            self.y0 = arrset(
                self.y0, np.where(self.congrps == ig_["X97"])[0], float(2.52000e02)
            )
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_ = {}
        elftv = []
        ...
        vname = "X1"
        [iv, ix_] = s2mpj_nlx(self, vname, ix_, 1, None, float(3.02400e03), float(0.0))
    ...
    def eSPHYD(self, nargout, *args):
        ...
        f_ = (
            self.elpar[iel_][0]
            + self.elpar[iel_][1] * PS
            + self.elpar[iel_][2] * PS * PS
        )
