    ...
    def __init__(self, *args):
        ...
        for I in range(int(v_["1"]), int(v_["NH"]) + 1):
            ...
            for K in range(int(v_["1"]), int(v_["NC"]) + 1):
                for S in range(int(v_["1"]), int(v_["NE"]) + 1):
                    [iv, ix_, _] = s2mpj_ii(
                        "W" + str(I) + "," + str(K) + "," + str(S), ix_
                    )
                    self.xnames = arrset(
                        self.xnames, iv, "W" + str(I) + "," + str(K) + "," + str(S)
                    )
            for J in range(int(v_["1"]), int(v_["NC"]) + 1):
                for S in range(int(v_["1"]), int(v_["NE"]) + 1):
                    [iv, ix_, _] = s2mpj_ii(
                        "U" + str(I) + "," + str(J) + "," + str(S), ix_
                    )
                    self.xnames = arrset(
                        self.xnames, iv, "U" + str(I) + "," + str(J) + "," + str(S)
                    )
                    [iv, ix_, _] = s2mpj_ii(
                        "DU" + str(I) + "," + str(J) + "," + str(S), ix_
                    )
                    self.xnames = arrset(
                        self.xnames, iv, "DU" + str(I) + "," + str(J) + "," + str(S)
                    )
        # %%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        ...
        for J in range(int(v_["1"]), int(v_["NM"]) + 1):
            ...
            for S in range(int(v_["1"]), int(v_["NE"]) + 1):
                ...
                for K in range(int(v_["1"]), int(v_["NC"]) + 1):
                    ...
                    icA = np.append(
                        icA,
                        [ix_["W" + str(int(v_["I"])) + "," + str(K) + "," + str(S)]],
                    )
        ...
        for I in range(int(v_["1"]), int(v_["NH"]) + 1):
            for J in range(int(v_["1"]), int(v_["NC"]) + 1):
                v_["RH"] = v_["RHO" + str(J)]
                [ig, ig_, _] = s2mpj_ii(
                    "U" + str(I) + "," + str(J) + "," + str(int(v_["1"])), ig_
                )
                gtype = arrset(gtype, ig, "==")
                cnames = arrset(
                    cnames, ig, "U" + str(I) + "," + str(J) + "," + str(int(v_["1"]))
                )
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["U" + str(I) + "," + str(J) + "," + str(int(v_["1"]))]]
                )
                valA = np.append(valA, float(-1.0))
                irA = np.append(irA, [ig])
                ...
                valA = np.append(valA, float(1.0))
                [ig, ig_, _] = s2mpj_ii(
                    "U" + str(I) + "," + str(J) + "," + str(int(v_["2"])), ig_
                )
                gtype = arrset(gtype, ig, "==")
                cnames = arrset(
                    cnames, ig, "U" + str(I) + "," + str(J) + "," + str(int(v_["2"]))
                )
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["U" + str(I) + "," + str(J) + "," + str(int(v_["2"]))]]
                )
                valA = np.append(valA, float(-1.0))
                irA = np.append(irA, [ig])
                ...
                for K in range(int(v_["1"]), int(v_["NC"]) + 1):
                    ...
                    cnames = arrset(
                        cnames,
                        ig,
                        "U" + str(I) + "," + str(J) + "," + str(int(v_["1"])),
                    )
                    irA = np.append(irA, [ig])
                    icA = np.append(
                        icA,
                        [ix_["W" + str(I) + "," + str(K) + "," + str(int(v_["1"]))]],
                    )
                    valA = np.append(valA, float(v_["COEF"]))
                    [ig, ig_, _] = s2mpj_ii(
                        "U" + str(I) + "," + str(J) + "," + str(int(v_["2"])), ig_
                    ...
                    cnames = arrset(
                        cnames,
                        ig,
                        "U" + str(I) + "," + str(J) + "," + str(int(v_["2"])),
                    )
                    irA = np.append(irA, [ig])
                    icA = np.append(
                        icA,
                        [ix_["W" + str(I) + "," + str(K) + "," + str(int(v_["2"]))]],
                    )
                    valA = np.append(valA, float(v_["COEF"]))
                    v_["PROD"] = v_["PROD"] * v_["RH"]
                [ig, ig_, _] = s2mpj_ii(
                    "DU" + str(I) + "," + str(J) + "," + str(int(v_["1"])), ig_
                )
                gtype = arrset(gtype, ig, "==")
                cnames = arrset(
                    cnames, ig, "DU" + str(I) + "," + str(J) + "," + str(int(v_["1"]))
                )
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["DU" + str(I) + "," + str(J) + "," + str(int(v_["1"]))]]
                )
                valA = np.append(valA, float(-1.0))
                [ig, ig_, _] = s2mpj_ii(
                    "DU" + str(I) + "," + str(J) + "," + str(int(v_["2"])), ig_
                )
                gtype = arrset(gtype, ig, "==")
                cnames = arrset(
                    cnames, ig, "DU" + str(I) + "," + str(J) + "," + str(int(v_["2"]))
                )
                irA = np.append(irA, [ig])
                icA = np.append(
                    icA, [ix_["DU" + str(I) + "," + str(J) + "," + str(int(v_["2"]))]]
                )
                valA = np.append(valA, float(-1.0))
                v_["PROD"] = 1.0
                for K in range(int(v_["1"]), int(v_["NC"]) + 1):
        ...
        for I in range(int(v_["1"]), int(v_["NH"]) + 1):
            for J in range(int(v_["1"]), int(v_["NC"]) + 1):
                for S in range(int(v_["1"]), int(v_["NE"]) + 1):
                    [ig, ig_, _] = s2mpj_ii(
                        "CO" + str(I) + "," + str(J) + "," + str(S), ig_
                    )
                    gtype = arrset(gtype, ig, "==")
                    cnames = arrset(
                        cnames, ig, "CO" + str(I) + "," + str(J) + "," + str(S)
                    )
                    irA = np.append(irA, [ig])
                    icA = np.append(
                        icA, [ix_["DU" + str(I) + "," + str(J) + "," + str(S)]]
                    )
                    valA = np.append(valA, float(1.0))
        # %%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        self.n = len(ix_)
        ...
        for I in range(int(v_["1"]), int(v_["NP"]) + 1):
            if "THETA" + str(I) in ix_:
                ...
                self.y0 = arrset(
                    self.y0,
                    findfirst(self.congrps, lambda x: x == ig_["THETA" + str(I)]),
                    float(0.0),
                )
        for I in range(int(v_["1"]), int(v_["NH"]) + 1):
            for J in range(int(v_["1"]), int(v_["NE"]) + 1):
            ...
            for S in range(int(v_["1"]), int(v_["NE"]) + 1):
                if "V" + str(I) + "," + str(S) in ix_:
                    ...
                    self.y0 = arrset(
                        ...
                        findfirst(
                            self.congrps,
                            lambda x: x == ig_["V" + str(I) + "," + str(S)],
                        ),
                        float(v_["BC" + str(S)]),
                    )
                for J in range(int(v_["1"]), int(v_["NC"]) + 1):
                    if "W" + str(I) + "," + str(J) + "," + str(S) in ix_:
                        self.x0[ix_["W" + str(I) + "," + str(J) + "," + str(S)]] = (
                            float(0.0)
                        )
                    else:
                        self.y0 = arrset(
                    ...
                    if "U" + str(I) + "," + str(J) + "," + str(S) in ix_:
                        ...
                        self.y0 = arrset(
                            ...
                            findfirst(
                                self.congrps,
                                lambda x: x
                                == ig_["U" + str(I) + "," + str(J) + "," + str(S)],
                            ),
                            float(v_["BC" + str(S)]),
                        )
                    if "DU" + str(I) + "," + str(J) + "," + str(S) in ix_:
                        self.x0[ix_["DU" + str(I) + "," + str(J) + "," + str(S)]] = (
                            float(0.0)
                        )
                    else:
                        self.y0 = arrset(
        ...
        for K in range(int(v_["2"]), int(v_["NM"]) + 1):
            ...
            for I in range(int(v_["I1"]), int(v_["I2"]) + 1):
                ...
                if "V" + str(I) + "," + str(int(v_["S"])) in ix_:
                    self.x0[ix_["V" + str(I) + "," + str(int(v_["S"]))]] = float(
                        v_["Z" + str(K) + "," + str(int(v_["S"]))]
                    )
                else:
                    self.y0 = arrset(
                        self.y0,
                        findfirst(
                            self.congrps,
                            lambda x: x == ig_["V" + str(I) + "," + str(int(v_["S"]))],
                        ),
                ...
                for J in range(int(v_["1"]), int(v_["NC"]) + 1):
                    if "W" + str(I) + "," + str(J) + "," + str(int(v_["S"])) in ix_:
                        self.x0[
                            ix_["W" + str(I) + "," + str(J) + "," + str(int(v_["S"]))]
                        ] = float(0.0)
                    else:
                        self.y0 = arrset(
                            self.y0,
                    ...
                    if "U" + str(I) + "," + str(J) + "," + str(int(v_["S"])) in ix_:
                        self.x0[
                            ix_["U" + str(I) + "," + str(J) + "," + str(int(v_["S"]))]
                        ] = float(v_["Z" + str(K) + "," + str(int(v_["S"]))])
                    else:
                        self.y0 = arrset(
                            self.y0,
                    ...
                    if "DU" + str(I) + "," + str(J) + "," + str(int(v_["S"])) in ix_:
                        self.x0[
                            ix_["DU" + str(I) + "," + str(J) + "," + str(int(v_["S"]))]
                        ] = float(0.0)
                    else:
                        self.y0 = arrset(
                            self.y0,
        ...
        for I in range(int(v_["I1"]), int(v_["I2"]) + 1):
            for S in range(int(v_["1"]), int(v_["NE"]) + 1):
                if "V" + str(I) + "," + str(S) in ix_:
                    self.x0[ix_["V" + str(I) + "," + str(S)]] = float(
                        v_["Z" + str(int(v_["NM"])) + "," + str(S)]
                    )
                else:
                    self.y0 = arrset(
                        self.y0,
        ...
        for I in range(int(v_["1"]), int(v_["NH"]) + 1):
            for J in range(int(v_["1"]), int(v_["NC"]) + 1):
                ...
                self.grelt = loaset(
                    self.grelt, ig, posel, ie_["P1" + str(I) + "," + str(J)]
                )
                ...
                posel = len(self.grelt[ig])
                self.grelt = loaset(
                    self.grelt, ig, posel, ie_["P2" + str(I) + "," + str(J)]
                )
                nlc = np.union1d(nlc, np.array([ig]))
                self.grelw = loaset(self.grelw, ig, posel, 1.0)
                posel = posel + 1
                self.grelt = loaset(
                    self.grelt, ig, posel, ie_["P3" + str(I) + "," + str(J)]
                )
                self.grelw = loaset(self.grelw, ig, posel, 1.0)
        for J in range(int(v_["1"]), int(v_["NM"]) + 1):
            for S in range(int(v_["1"]), int(v_["NE"]) + 1):
