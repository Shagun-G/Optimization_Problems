...
class LAKES(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        for I in range(int(v_["1"]), int(v_["N"]) + 1):
            ...
            self.xnames = arrset(
                self.xnames, iv, "V" + str(I) + "," + str(int(v_["2"]))
            )
            [iv, ix_, _] = s2mpj_ii("W" + str(I) + "," + str(int(v_["2"])), ix_)
            self.xnames = arrset(
                self.xnames, iv, "W" + str(I) + "," + str(int(v_["2"]))
            )
            [iv, ix_, _] = s2mpj_ii("V" + str(I) + "," + str(int(v_["3"])), ix_)
            self.xnames = arrset(
                self.xnames, iv, "V" + str(I) + "," + str(int(v_["3"]))
            )
            [iv, ix_, _] = s2mpj_ii("W" + str(I) + "," + str(int(v_["3"])), ix_)
            self.xnames = arrset(
                self.xnames, iv, "W" + str(I) + "," + str(int(v_["3"]))
            )
            [iv, ix_, _] = s2mpj_ii("V" + str(I) + "," + str(int(v_["4"])), ix_)
            self.xnames = arrset(
                self.xnames, iv, "V" + str(I) + "," + str(int(v_["4"]))
            )
        # %%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        ...
        for j in range(int(v_["2"]), int(v_["5"]) + 1):
            ...
            irA = np.append(irA, [ig])
            icA = np.append(
                icA, [ix_["O" + str(int(v_["N"])) + "," + str(int(v_["j-1"]))]]
            )
            valA = np.append(valA, float(-1.0))
        for i in range(int(v_["1"]), int(v_["N"]) + 1):
        ...
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["1"])) + "," + str(int(v_["1"]))],
            float(v_["S1s1"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["1"])) + "," + str(int(v_["2"]))],
            float(v_["S1s2"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["1"])) + "," + str(int(v_["3"]))],
            float(v_["S1s3"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["1"])) + "," + str(int(v_["4"]))],
            float(v_["S1s4"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["1"])) + "," + str(int(v_["5"]))],
            float(v_["S1s5"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["2"])) + "," + str(int(v_["1"]))],
            float(v_["S2s1"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["2"])) + "," + str(int(v_["2"]))],
            float(v_["S2s2"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["2"])) + "," + str(int(v_["3"]))],
            float(v_["S2s3"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["2"])) + "," + str(int(v_["4"]))],
            float(v_["S2s4"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["2"])) + "," + str(int(v_["5"]))],
            float(v_["S2s5"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["3"])) + "," + str(int(v_["1"]))],
            float(v_["S3s1"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["3"])) + "," + str(int(v_["2"]))],
            float(v_["S3s2"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["3"])) + "," + str(int(v_["3"]))],
            float(v_["S3s3"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["3"])) + "," + str(int(v_["4"]))],
            float(v_["S3s4"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["3"])) + "," + str(int(v_["5"]))],
            float(v_["S3s5"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["4"])) + "," + str(int(v_["1"]))],
            float(v_["S4s1"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["4"])) + "," + str(int(v_["2"]))],
            float(v_["S4s2"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["4"])) + "," + str(int(v_["3"]))],
            float(v_["S4s3"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["4"])) + "," + str(int(v_["4"]))],
            float(v_["S4s4"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["4"])) + "," + str(int(v_["5"]))],
            float(v_["S4s5"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["5"])) + "," + str(int(v_["1"]))],
            float(v_["S5s1"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["5"])) + "," + str(int(v_["2"]))],
            float(v_["S5s2"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["5"])) + "," + str(int(v_["3"]))],
            float(v_["S5s3"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["5"])) + "," + str(int(v_["4"]))],
            float(v_["S5s4"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["5"])) + "," + str(int(v_["5"]))],
            float(v_["S5s5"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["6"])) + "," + str(int(v_["1"]))],
            float(v_["S6s1"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["6"])) + "," + str(int(v_["2"]))],
            float(v_["S6s2"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["6"])) + "," + str(int(v_["3"]))],
            float(v_["S6s3"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["6"])) + "," + str(int(v_["4"]))],
            float(v_["S6s4"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["6"])) + "," + str(int(v_["5"]))],
            float(v_["S6s5"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["7"])) + "," + str(int(v_["1"]))],
            float(v_["O1o5"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["7"])) + "," + str(int(v_["2"]))],
            float(v_["O1o2"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["7"])) + "," + str(int(v_["3"]))],
            float(v_["O1o3"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["7"])) + "," + str(int(v_["4"]))],
            float(v_["O1o4"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["7"])) + "," + str(int(v_["5"]))],
            float(v_["O1o5"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["8"])) + "," + str(int(v_["1"]))],
            float(v_["O2o1"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["8"])) + "," + str(int(v_["2"]))],
            float(v_["O2o2"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["8"])) + "," + str(int(v_["3"]))],
            float(v_["O2o3"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["8"])) + "," + str(int(v_["4"]))],
            float(v_["O2o4"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["8"])) + "," + str(int(v_["5"]))],
            float(v_["O2o5"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["9"])) + "," + str(int(v_["1"]))],
            float(v_["O3o1"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["9"])) + "," + str(int(v_["2"]))],
            float(v_["O3o2"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["9"])) + "," + str(int(v_["3"]))],
            float(v_["O3o3"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["9"])) + "," + str(int(v_["4"]))],
            float(v_["O3o4"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["9"])) + "," + str(int(v_["5"]))],
            float(v_["O3o5"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["10"])) + "," + str(int(v_["1"]))],
            float(v_["O4o1"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["10"])) + "," + str(int(v_["2"]))],
            float(v_["O4o2"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["10"])) + "," + str(int(v_["3"]))],
            float(v_["O4o3"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["10"])) + "," + str(int(v_["4"]))],
            float(v_["O4o4"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["10"])) + "," + str(int(v_["5"]))],
            float(v_["O4o5"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["11"])) + "," + str(int(v_["1"]))],
            float(v_["O5o1"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["11"])) + "," + str(int(v_["2"]))],
            float(v_["O5o2"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["11"])) + "," + str(int(v_["3"]))],
            float(v_["O5o3"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["11"])) + "," + str(int(v_["4"]))],
            float(v_["O5o4"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["11"])) + "," + str(int(v_["5"]))],
            float(v_["O5o5"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["12"])) + "," + str(int(v_["1"]))],
            float(v_["O6o1"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["12"])) + "," + str(int(v_["2"]))],
            float(v_["O6o2"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["12"])) + "," + str(int(v_["3"]))],
            float(v_["O6o3"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["12"])) + "," + str(int(v_["4"]))],
            float(v_["O6o4"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["R" + str(int(v_["12"])) + "," + str(int(v_["5"]))],
            float(v_["O6o5"]),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["1"])) + "," + str(int(v_["1"]))],
            float(-22.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["1"])) + "," + str(int(v_["2"]))],
            float(-1.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["1"])) + "," + str(int(v_["3"]))],
            float(3.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["1"])) + "," + str(int(v_["4"]))],
            float(-27.2),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["1"])) + "," + str(int(v_["5"]))],
            float(51.5),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["2"])) + "," + str(int(v_["1"]))],
            float(44.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["2"])) + "," + str(int(v_["2"]))],
            float(162.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["2"])) + "," + str(int(v_["3"]))],
            float(8.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["2"])) + "," + str(int(v_["4"]))],
            float(12.5),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["2"])) + "," + str(int(v_["5"]))],
            float(53.5),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["3"])) + "," + str(int(v_["1"]))],
            float(-11.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["3"])) + "," + str(int(v_["2"]))],
            float(60.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["3"])) + "," + str(int(v_["3"]))],
            float(10.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["3"])) + "," + str(int(v_["4"]))],
            float(18.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["3"])) + "," + str(int(v_["5"]))],
            float(39.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["4"])) + "," + str(int(v_["1"]))],
            float(124.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["4"])) + "," + str(int(v_["2"]))],
            float(246.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["4"])) + "," + str(int(v_["3"]))],
            float(6.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["4"])) + "," + str(int(v_["4"]))],
            float(9.7),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["4"])) + "," + str(int(v_["5"]))],
            float(17.2),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["5"])) + "," + str(int(v_["1"]))],
            float(127.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["5"])) + "," + str(int(v_["2"]))],
            float(175.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["5"])) + "," + str(int(v_["3"]))],
            float(3.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["5"])) + "," + str(int(v_["4"]))],
            float(10.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["5"])) + "," + str(int(v_["5"]))],
            float(30.2),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["6"])) + "," + str(int(v_["1"]))],
            float(78.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["6"])) + "," + str(int(v_["2"]))],
            float(156.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["6"])) + "," + str(int(v_["3"]))],
            float(3.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["6"])) + "," + str(int(v_["4"]))],
            float(14.0),
        )
        self.gconst = arrset(
            self.gconst,
            ig_["G" + str(int(v_["6"])) + "," + str(int(v_["5"]))],
            float(23.2),
        )
        for i in range(int(v_["1"]), int(v_["N"]) + 1):
            self.gconst = arrset(
                self.gconst, ig_["V" + str(i) + "," + str(int(v_["2"]))], float(543.4)
            )
            self.gconst = arrset(
                self.gconst, ig_["W" + str(i) + "," + str(int(v_["2"]))], float(0.0)
            )
            self.gconst = arrset(
                self.gconst, ig_["V" + str(i) + "," + str(int(v_["3"]))], float(543.4)
            )
            self.gconst = arrset(
                self.gconst, ig_["W" + str(i) + "," + str(int(v_["3"]))], float(0.0)
            )
            self.gconst = arrset(
                self.gconst, ig_["V" + str(i) + "," + str(int(v_["4"]))], float(550.11)
            )
        # %%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        for i in range(int(v_["1"]), int(v_["N"]) + 1):
            ...
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["B" + str(i) + "," + str(int(v_["1"]))]
            )
            ...
            posel = len(self.grelt[ig])
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["B" + str(i) + "," + str(int(v_["2"]))]
            )
            nlc = np.union1d(nlc, np.array([ig]))
            self.grelw = loaset(self.grelw, ig, posel, 1.0)
            ...
            posel = len(self.grelt[ig])
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["B" + str(i) + "," + str(int(v_["3"]))]
            )
            nlc = np.union1d(nlc, np.array([ig]))
            self.grelw = loaset(self.grelw, ig, posel, 1.0)
        for i in range(int(v_["1"]), int(v_["N"]) + 1):
