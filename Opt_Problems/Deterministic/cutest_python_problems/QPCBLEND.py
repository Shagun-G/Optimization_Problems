...
class QPCBLEND(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        valA = np.append(valA, float(-0.537))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["3"]])
        valA = np.append(valA, float(-0.131))
        [iv, ix_, _] = s2mpj_ii("1", ix_)
        self.xnames = arrset(self.xnames, iv, "1")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["4"]])
        valA = np.append(valA, float(-0.1155))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["5"]])
        valA = np.append(valA, float(-0.0365))
        [iv, ix_, _] = s2mpj_ii("1", ix_)
        self.xnames = arrset(self.xnames, iv, "1")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["6"]])
        valA = np.append(valA, float(-0.143))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["7"]])
        valA = np.append(valA, float(-0.037))
        [iv, ix_, _] = s2mpj_ii("1", ix_)
        self.xnames = arrset(self.xnames, iv, "1")
        icA = np.append(icA, [iv])
        ...
        valA = np.append(valA, float(0.0587))
        [iv, ix_, _] = s2mpj_ii("1", ix_)
        self.xnames = arrset(self.xnames, iv, "1")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["42"]])
        valA = np.append(valA, float(0.15))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["43"]])
        valA = np.append(valA, float(0.302))
        [iv, ix_, _] = s2mpj_ii("1", ix_)
        self.xnames = arrset(self.xnames, iv, "1")
        icA = np.append(icA, [iv])
        ...
        valA = np.append(valA, float(-0.2931))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["3"]])
        valA = np.append(valA, float(-0.117))
        [iv, ix_, _] = s2mpj_ii("2", ix_)
        self.xnames = arrset(self.xnames, iv, "2")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["4"]])
        valA = np.append(valA, float(-0.0649))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["5"]])
        valA = np.append(valA, float(-0.1233))
        [iv, ix_, _] = s2mpj_ii("2", ix_)
        self.xnames = arrset(self.xnames, iv, "2")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["6"]])
        valA = np.append(valA, float(-0.2217))
        icA = np.append(icA, [iv])
        ...
        valA = np.append(valA, float(0.0042))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["40"]])
        valA = np.append(valA, float(0.003))
        [iv, ix_, _] = s2mpj_ii("2", ix_)
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["41"]])
        valA = np.append(valA, float(0.1053))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["42"]])
        valA = np.append(valA, float(0.185))
        [iv, ix_, _] = s2mpj_ii("2", ix_)
        self.xnames = arrset(self.xnames, iv, "2")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["43"]])
        valA = np.append(valA, float(0.384))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["50"]])
        valA = np.append(valA, float(-0.00862))
        [iv, ix_, _] = s2mpj_ii("2", ix_)
        self.xnames = arrset(self.xnames, iv, "2")
        icA = np.append(icA, [iv])
        ...
        valA = np.append(valA, float(-0.0101))
        [iv, ix_, _] = s2mpj_ii("2", ix_)
        self.xnames = arrset(self.xnames, iv, "2")
        icA = np.append(icA, [iv])
        ...
        valA = np.append(valA, float(-0.0277))
        [iv, ix_, _] = s2mpj_ii("3", ix_)
        self.xnames = arrset(self.xnames, iv, "3")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["10"]])
        valA = np.append(valA, float(-0.0563))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["11"]])
        valA = np.append(valA, float(-0.199))
        [iv, ix_, _] = s2mpj_ii("3", ix_)
        self.xnames = arrset(self.xnames, iv, "3")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["12"]])
        valA = np.append(valA, float(-0.6873))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["13"]])
        valA = np.append(valA, float(-0.017))
        [iv, ix_, _] = s2mpj_ii("3", ix_)
        self.xnames = arrset(self.xnames, iv, "3")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["40"]])
        valA = np.append(valA, float(0.01303))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["41"]])
        valA = np.append(valA, float(0.0506))
        [iv, ix_, _] = s2mpj_ii("3", ix_)
        self.xnames = arrset(self.xnames, iv, "3")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["42"]])
        valA = np.append(valA, float(0.209))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["43"]])
        valA = np.append(valA, float(0.495))
        [iv, ix_, _] = s2mpj_ii("3", ix_)
        self.xnames = arrset(self.xnames, iv, "3")
        icA = np.append(icA, [iv])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["9"]])
        valA = np.append(valA, float(-0.0112))
        [iv, ix_, _] = s2mpj_ii("4", ix_)
        self.xnames = arrset(self.xnames, iv, "4")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["10"]])
        valA = np.append(valA, float(-0.0378))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["11"]])
        valA = np.append(valA, float(-0.1502))
        [iv, ix_, _] = s2mpj_ii("4", ix_)
        self.xnames = arrset(self.xnames, iv, "4")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["12"]])
        valA = np.append(valA, float(-0.7953))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["13"]])
        valA = np.append(valA, float(-0.0099))
        [iv, ix_, _] = s2mpj_ii("4", ix_)
        self.xnames = arrset(self.xnames, iv, "4")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["40"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["41"]])
        valA = np.append(valA, float(0.0448))
        [iv, ix_, _] = s2mpj_ii("4", ix_)
        self.xnames = arrset(self.xnames, iv, "4")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["42"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["43"]])
        valA = np.append(valA, float(0.721))
        [iv, ix_, _] = s2mpj_ii("4", ix_)
        self.xnames = arrset(self.xnames, iv, "4")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["65"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["9"]])
        valA = np.append(valA, float(-0.175))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["10"]])
        valA = np.append(valA, float(-0.27))
        [iv, ix_, _] = s2mpj_ii("5", ix_)
        self.xnames = arrset(self.xnames, iv, "5")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["11"]])
        valA = np.append(valA, float(-0.028))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["13"]])
        valA = np.append(valA, float(-0.455))
        [iv, ix_, _] = s2mpj_ii("5", ix_)
        self.xnames = arrset(self.xnames, iv, "5")
        icA = np.append(icA, [iv])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["9"]])
        valA = np.append(valA, float(-0.271))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["10"]])
        valA = np.append(valA, float(-0.3285))
        [iv, ix_, _] = s2mpj_ii("6", ix_)
        self.xnames = arrset(self.xnames, iv, "6")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["11"]])
        valA = np.append(valA, float(-0.0255))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["13"]])
        valA = np.append(valA, float(-0.2656))
        [iv, ix_, _] = s2mpj_ii("6", ix_)
        self.xnames = arrset(self.xnames, iv, "6")
        icA = np.append(icA, [iv])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["9"]])
        valA = np.append(valA, float(-0.2836))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["10"]])
        valA = np.append(valA, float(-0.3285))
        [iv, ix_, _] = s2mpj_ii("7", ix_)
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["11"]])
        valA = np.append(valA, float(-0.0241))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["13"]])
        valA = np.append(valA, float(-0.2502))
        [iv, ix_, _] = s2mpj_ii("7", ix_)
        self.xnames = arrset(self.xnames, iv, "7")
        icA = np.append(icA, [iv])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["39"]])
        valA = np.append(valA, float(0.0327))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["41"]])
        valA = np.append(valA, float(0.094))
        [iv, ix_, _] = s2mpj_ii("8", ix_)
        self.xnames = arrset(self.xnames, iv, "8")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["42"]])
        valA = np.append(valA, float(0.045))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["43"]])
        valA = np.append(valA, float(0.793))
        [iv, ix_, _] = s2mpj_ii("8", ix_)
        self.xnames = arrset(self.xnames, iv, "8")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["C"]])
        valA = np.append(valA, float(0.0044))
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["17"]])
        valA = np.append(valA, float(-0.0588))
        [iv, ix_, _] = s2mpj_ii("13", ix_)
        self.xnames = arrset(self.xnames, iv, "13")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["19"]])
        valA = np.append(valA, float(-0.8145))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["23"]])
        valA = np.append(valA, float(-0.0091))
        [iv, ix_, _] = s2mpj_ii("13", ix_)
        self.xnames = arrset(self.xnames, iv, "13")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["39"]])
        valA = np.append(valA, float(-0.8239))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["40"]])
        valA = np.append(valA, float(0.0081))
        [iv, ix_, _] = s2mpj_ii("13", ix_)
        self.xnames = arrset(self.xnames, iv, "13")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["41"]])
        valA = np.append(valA, float(-0.2112))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["42"]])
        valA = np.append(valA, float(0.387))
        [iv, ix_, _] = s2mpj_ii("13", ix_)
        self.xnames = arrset(self.xnames, iv, "13")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["43"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["C"]])
        valA = np.append(valA, float(0.07))
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["18"]])
        valA = np.append(valA, float(-0.0404))
        [iv, ix_, _] = s2mpj_ii("14", ix_)
        self.xnames = arrset(self.xnames, iv, "14")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["20"]])
        valA = np.append(valA, float(-0.8564))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["23"]])
        valA = np.append(valA, float(-0.0069))
        [iv, ix_, _] = s2mpj_ii("14", ix_)
        self.xnames = arrset(self.xnames, iv, "14")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["39"]])
        valA = np.append(valA, float(-0.7689))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["40"]])
        valA = np.append(valA, float(0.0063))
        [iv, ix_, _] = s2mpj_ii("14", ix_)
        self.xnames = arrset(self.xnames, iv, "14")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["41"]])
        valA = np.append(valA, float(-0.156))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["42"]])
        valA = np.append(valA, float(0.297))
        [iv, ix_, _] = s2mpj_ii("14", ix_)
        self.xnames = arrset(self.xnames, iv, "14")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["43"]])
        valA = np.append(valA, float(0.792))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["69"]])
        valA = np.append(valA, float(1.0))
        [iv, ix_, _] = s2mpj_ii("14", ix_)
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["21"]])
        valA = np.append(valA, float(-0.3321))
        [iv, ix_, _] = s2mpj_ii("15", ix_)
        self.xnames = arrset(self.xnames, iv, "15")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["22"]])
        valA = np.append(valA, float(-0.5875))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["23"]])
        valA = np.append(valA, float(-0.362))
        [iv, ix_, _] = s2mpj_ii("15", ix_)
        self.xnames = arrset(self.xnames, iv, "15")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["39"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["41"]])
        valA = np.append(valA, float(-0.2049))
        [iv, ix_, _] = s2mpj_ii("15", ix_)
        self.xnames = arrset(self.xnames, iv, "15")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["42"]])
        valA = np.append(valA, float(0.826))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["43"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["C"]])
        valA = np.append(valA, float(0.155))
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["21"]])
        valA = np.append(valA, float(-0.2414))
        [iv, ix_, _] = s2mpj_ii("17", ix_)
        self.xnames = arrset(self.xnames, iv, "17")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["22"]])
        valA = np.append(valA, float(-0.6627))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["23"]])
        valA = np.append(valA, float(-0.293))
        [iv, ix_, _] = s2mpj_ii("17", ix_)
        self.xnames = arrset(self.xnames, iv, "17")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["39"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["41"]])
        valA = np.append(valA, float(-0.1531))
        [iv, ix_, _] = s2mpj_ii("17", ix_)
        self.xnames = arrset(self.xnames, iv, "17")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["42"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["10"]])
        valA = np.append(valA, float(-0.0185))
        [iv, ix_, _] = s2mpj_ii("19", ix_)
        self.xnames = arrset(self.xnames, iv, "19")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["13"]])
        valA = np.append(valA, float(-0.0568))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["24"]])
        valA = np.append(valA, float(-0.0806))
        [iv, ix_, _] = s2mpj_ii("19", ix_)
        self.xnames = arrset(self.xnames, iv, "19")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["25"]])
        valA = np.append(valA, float(-0.0658))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["26"]])
        valA = np.append(valA, float(-0.0328))
        [iv, ix_, _] = s2mpj_ii("19", ix_)
        self.xnames = arrset(self.xnames, iv, "19")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["27"]])
        valA = np.append(valA, float(-0.4934))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["28"]])
        valA = np.append(valA, float(-0.2922))
        [iv, ix_, _] = s2mpj_ii("19", ix_)
        self.xnames = arrset(self.xnames, iv, "19")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["29"]])
        valA = np.append(valA, float(-0.0096))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["40"]])
        valA = np.append(valA, float(-0.0654))
        [iv, ix_, _] = s2mpj_ii("19", ix_)
        self.xnames = arrset(self.xnames, iv, "19")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["41"]])
        valA = np.append(valA, float(-0.2535))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["42"]])
        valA = np.append(valA, float(0.632))
        [iv, ix_, _] = s2mpj_ii("19", ix_)
        self.xnames = arrset(self.xnames, iv, "19")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["43"]])
        valA = np.append(valA, float(0.6807))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["65"]])
        valA = np.append(valA, float(1.0))
        [iv, ix_, _] = s2mpj_ii("19", ix_)
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["C"]])
        valA = np.append(valA, float(0.0528))
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["10"]])
        valA = np.append(valA, float(-0.0184))
        [iv, ix_, _] = s2mpj_ii("21", ix_)
        self.xnames = arrset(self.xnames, iv, "21")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["13"]])
        valA = np.append(valA, float(-0.0564))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["24"]])
        valA = np.append(valA, float(-0.078))
        [iv, ix_, _] = s2mpj_ii("21", ix_)
        self.xnames = arrset(self.xnames, iv, "21")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["25"]])
        valA = np.append(valA, float(-0.0655))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["26"]])
        valA = np.append(valA, float(-0.0303))
        [iv, ix_, _] = s2mpj_ii("21", ix_)
        self.xnames = arrset(self.xnames, iv, "21")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["27"]])
        valA = np.append(valA, float(-0.475))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["28"]])
        valA = np.append(valA, float(-0.305))
        [iv, ix_, _] = s2mpj_ii("21", ix_)
        self.xnames = arrset(self.xnames, iv, "21")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["40"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["41"]])
        valA = np.append(valA, float(-0.2703))
        [iv, ix_, _] = s2mpj_ii("21", ix_)
        self.xnames = arrset(self.xnames, iv, "21")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["42"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["13"]])
        valA = np.append(valA, float(0.76))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["25"]])
        valA = np.append(valA, float(0.5714))
        [iv, ix_, _] = s2mpj_ii("23", ix_)
        self.xnames = arrset(self.xnames, iv, "23")
        icA = np.append(icA, [iv])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["40"]])
        valA = np.append(valA, float(0.1869))
        [iv, ix_, _] = s2mpj_ii("23", ix_)
        self.xnames = arrset(self.xnames, iv, "23")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["41"]])
        valA = np.append(valA, float(0.2796))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["42"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["C"]])
        valA = np.append(valA, float(0.128))
        [iv, ix_, _] = s2mpj_ii("24", ix_)
        self.xnames = arrset(self.xnames, iv, "24")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["9"]])
        valA = np.append(valA, float(-0.0571))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["10"]])
        valA = np.append(valA, float(-0.0114))
        [iv, ix_, _] = s2mpj_ii("24", ix_)
        self.xnames = arrset(self.xnames, iv, "24")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["13"]])
        valA = np.append(valA, float(0.6571))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["24"]])
        valA = np.append(valA, float(0.5714))
        [iv, ix_, _] = s2mpj_ii("24", ix_)
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["40"]])
        valA = np.append(valA, float(0.1724))
        [iv, ix_, _] = s2mpj_ii("24", ix_)
        self.xnames = arrset(self.xnames, iv, "24")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["41"]])
        valA = np.append(valA, float(0.2579))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["42"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["C"]])
        valA = np.append(valA, float(0.118))
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["48"]])
        valA = np.append(valA, float(0.233))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["49"]])
        valA = np.append(valA, float(-0.358))
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["48"]])
        valA = np.append(valA, float(0.205))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["49"]])
        valA = np.append(valA, float(-0.333))
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["48"]])
        valA = np.append(valA, float(0.381))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["49"]])
        valA = np.append(valA, float(-0.509))
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["48"]])
        valA = np.append(valA, float(0.39))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["49"]])
        valA = np.append(valA, float(-0.77))
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["49"]])
        valA = np.append(valA, float(-0.58))
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["44"]])
        valA = np.append(valA, float(-0.493))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["45"]])
        valA = np.append(valA, float(-0.165))
        [iv, ix_, _] = s2mpj_ii("36", ix_)
        self.xnames = arrset(self.xnames, iv, "36")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["46"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["C"]])
        valA = np.append(valA, float(0.0924))
        ...
        valA = np.append(valA, float(0.64))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["74"]])
        valA = np.append(valA, float(0.35))
        [iv, ix_, _] = s2mpj_ii("37", ix_)
        self.xnames = arrset(self.xnames, iv, "37")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["C"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["54"]])
        valA = np.append(valA, float(0.318))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["55"]])
        valA = np.append(valA, float(-0.509))
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["50"]])
        valA = np.append(valA, float(-0.435))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["51"]])
        valA = np.append(valA, float(-0.208))
        [iv, ix_, _] = s2mpj_ii("44", ix_)
        self.xnames = arrset(self.xnames, iv, "44")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["52"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["73"]])
        valA = np.append(valA, float(-0.36))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["74"]])
        valA = np.append(valA, float(0.35))
        [iv, ix_, _] = s2mpj_ii("45", ix_)
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["56"]])
        valA = np.append(valA, float(-0.426))
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["57"]])
        valA = np.append(valA, float(-0.204))
        [iv, ix_, _] = s2mpj_ii("52", ix_)
        self.xnames = arrset(self.xnames, iv, "52")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["58"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["74"]])
        valA = np.append(valA, float(-0.65))
        [iv, ix_, _] = s2mpj_ii("53", ix_)
        self.xnames = arrset(self.xnames, iv, "53")
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["C"]])
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["C"]])
        valA = np.append(valA, float(0.04))
        ...
        icA = np.append(icA, [iv])
        irA = np.append(irA, [ig_["C"]])
        valA = np.append(valA, float(0.0132))
