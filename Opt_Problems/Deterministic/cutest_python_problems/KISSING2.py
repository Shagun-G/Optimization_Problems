...
class KISSING2(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        for I in range(int(v_["1"]), int(v_["m"]) + 1):
            for J in range(int(v_["1"]), int(v_["m"]) + 1):
                self.gconst = arrset(
                    self.gconst, ig_["C" + str(I) + "," + str(J)], float(4.0)
                )
        # %%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        for I in range(int(v_["1"]), int(v_["m"]) + 1):
            ...
            if "P" + str(I) + "," + str(int(v_["1"])) in ix_:
                ...
                self.y0 = arrset(
                    ...
                    findfirst(
                        self.congrps,
                        lambda x: x == ig_["P" + str(I) + "," + str(int(v_["1"]))],
                    ),
                    float(v_["cos"]),
                )
            for J in range(int(v_["2"]), int(v_["n-1"]) + 1):
                if "P" + str(I) + "," + str(J) in ix_:
                    ...
                    self.y0 = arrset(
                        ...
                        findfirst(
                            self.congrps,
                            lambda x: x == ig_["P" + str(I) + "," + str(J)],
                        ),
                        float(v_["sin"]),
                    )
        if "P" + str(int(v_["m"])) + "," + str(int(v_["n"])) in ix_:
            self.x0[ix_["P" + str(int(v_["m"])) + "," + str(int(v_["n"]))]] = float(
                v_["cos"]
            )
        else:
            self.y0 = arrset(
                ...
                findfirst(
                    self.congrps,
                    lambda x: x
                    == ig_["P" + str(int(v_["m"])) + "," + str(int(v_["n"]))],
                ),
                float(v_["cos"]),
            )
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
