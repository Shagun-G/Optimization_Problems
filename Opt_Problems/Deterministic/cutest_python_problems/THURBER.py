...
class THURBER(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        if "B2" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["B2"]),
                float(1000.0),
            )
        if "B3" in ix_:
            ...
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["B3"]), float(400.0)
            )
        if "B4" in ix_:
        ...
        if "B6" in ix_:
            ...
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["B6"]), float(0.3)
            )
        if "B7" in ix_:
            self.x0[ix_["B7"]] = float(0.03)
        else:
            self.y0 = arrset(
                self.y0, findfirst(self.congrps, lambda x: x == ig_["B7"]), float(0.03)
            )
        pass
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_ = {}
