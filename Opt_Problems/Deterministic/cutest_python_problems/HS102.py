...
class HS102(CUTEst_problem):
    ...
    def en3PR(self, nargout, *args):
        ...
        if nargout > 1:
            ...
            if nargout > 2:
                ...
                H_[0, 0] = (
                    FVALUE
                    * (self.elpar[iel_][0] / EV_[0])
                    * ((self.elpar[iel_][0] - 1.0) / EV_[0])
                )
                H_[1, 1] = (
                    FVALUE
                    * (self.elpar[iel_][1] / EV_[1])
                    * ((self.elpar[iel_][1] - 1.0) / EV_[1])
                )
                H_[2, 2] = (
                    FVALUE
                    * (self.elpar[iel_][2] / EV_[2])
                    * ((self.elpar[iel_][2] - 1.0) / EV_[2])
                )
                H_[0, 1] = (
                    FVALUE
                    * (self.elpar[iel_][0] / EV_[0])
    ...
    def en4PR(self, nargout, *args):
        ...
        if nargout > 1:
            ...
            if nargout > 2:
                ...
                H_[3, 3] = (
                    FVALUE
                    * (self.elpar[iel_][3] / EV_[3])
                    * ((self.elpar[iel_][3] - 1.0) / EV_[3])
                )
                H_[0, 1] = (
                    FVALUE
                    * (self.elpar[iel_][0] / EV_[0])
    ...
    def en5PR(self, nargout, *args):
        ...
        if nargout > 1:
            ...
            if nargout > 2:
                ...
                H_[4, 4] = (
                    FVALUE
                    * (self.elpar[iel_][4] / EV_[4])
                    * ((self.elpar[iel_][4] - 1.0) / EV_[4])
                )
                H_[0, 1] = (
                    FVALUE
                    * (self.elpar[iel_][0] / EV_[0])
    ...
    def en6PR(self, nargout, *args):
        ...
        FVALUE = (
            (EV_[0] ** self.elpar[iel_][0])
            * (EV_[1] ** self.elpar[iel_][2])
            * (EV_[2] ** self.elpar[iel_][3])
            * (EV_[3] ** self.elpar[iel_][4])
            * (EV_[4] ** self.elpar[iel_][5])
            * (EV_[5] ** self.elpar[iel_][1])
        )
        f_ = FVALUE
        if not isinstance(f_, float):
            f_ = f_.item()
        if nargout > 1:
            ...
            if nargout > 2:
                ...
                H_[1, 1] = (
                    ...
                    * ((self.elpar[iel_][2] - 1.0) / EV_[1])
                )
                H_[2, 2] = (
                    FVALUE
                    * (self.elpar[iel_][3] / EV_[2])
                    * ((self.elpar[iel_][3] - 1.0) / EV_[2])
                )
                H_[3, 3] = (
                    FVALUE
                    * (self.elpar[iel_][4] / EV_[3])
                    * ((self.elpar[iel_][4] - 1.0) / EV_[3])
                )
                H_[4, 4] = (
                    FVALUE
                    * (self.elpar[iel_][5] / EV_[4])
                    * ((self.elpar[iel_][5] - 1.0) / EV_[4])
                )
                H_[5, 5] = (
                    FVALUE
                    * (self.elpar[iel_][1] / EV_[5])
                    * ((self.elpar[iel_][1] - 1.0) / EV_[5])
                )
                H_[0, 1] = (
                    FVALUE
                    * (self.elpar[iel_][0] / EV_[0])
