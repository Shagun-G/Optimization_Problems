...
class LEAKNET(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        self.xlower[ix_["S1"]] = 0.00000e00
        self.xupper[ix_["S1"]] = 0.10000e08
        self.xlower[ix_["S23"]] = 0.00000e00
        self.xupper[ix_["S23"]] = 0.10000e08
        self.xlower[ix_["S101"]] = 0.00000e00
        self.xupper[ix_["S101"]] = 0.10000e08
        ...
        if "P1" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P1"]),
                float(49.9999542),
            )
        if "P2" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P2"]),
                float(49.9235382),
            )
        if "P3" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P3"]),
                float(49.8521347),
            )
        if "P4" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P4"]),
                float(49.8023033),
            )
        if "P5" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P5"]),
                float(49.5280037),
            )
        if "P6" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P6"]),
                float(49.4430084),
            )
        if "P9" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P9"]),
                float(49.4192848),
            )
        if "P10" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P10"]),
                float(48.9165802),
            )
        if "P12" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P12"]),
                float(48.4542847),
            )
        if "P13" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P13"]),
                float(48.0059395),
            )
        if "P14" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P14"]),
                float(45.8674431),
            )
        if "P15" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P15"]),
                float(45.0843582),
            )
        if "P16" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P16"]),
                float(49.2248535),
            )
        if "P17" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P17"]),
                float(47.6257820),
            )
        if "P18" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P18"]),
                float(48.7873573),
            )
        if "P19" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P19"]),
                float(47.4473228),
            )
        if "P20" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P20"]),
                float(47.0119705),
            )
        if "P21" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P21"]),
                float(45.4362640),
            )
        if "P22" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P22"]),
                float(49.6542473),
            )
        if "P23" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P23"]),
                float(49.9999542),
            )
        if "P26" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P26"]),
                float(49.3843575),
            )
        if "P27" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P27"]),
                float(49.2706299),
            )
        if "P101" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P101"]),
                float(49.9999542),
            )
        if "P102" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P102"]),
                float(49.7797737),
            )
        if "P103" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P103"]),
                float(49.6217003),
            )
        if "P104" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P104"]),
                float(49.3556252),
            )
        if "P105" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P105"]),
                float(48.9891777),
            )
        if "P106" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P106"]),
                float(48.8152504),
            )
        if "P107" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P107"]),
                float(48.7247696),
            )
        if "P108" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P108"]),
                float(44.6206322),
            )
        if "P109" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P109"]),
                float(44.6906090),
            )
        if "P110" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P110"]),
                float(44.5836792),
            )
        if "P111" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P111"]),
                float(47.5885887),
            )
        if "P112" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P112"]),
                float(44.7669029),
            )
        if "P201" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P201"]),
                float(48.5901833),
            )
        if "P202" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P202"]),
                float(48.2493629),
            )
        if "P203" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P203"]),
                float(47.5757141),
            )
        if "P204" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P204"]),
                float(46.9474792),
            )
        if "P205" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P205"]),
                float(47.2141495),
            )
        if "P206" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P206"]),
                float(48.1905937),
            )
        if "P207" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P207"]),
                float(46.4013824),
            )
        if "P208" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P208"]),
                float(47.0579872),
            )
        if "P209" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P209"]),
                float(45.6997147),
            )
        if "P210" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P210"]),
                float(47.4423180),
            )
        if "P211" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P211"]),
                float(47.8950729),
            )
        if "P212" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P212"]),
                float(46.8515167),
            )
        if "P301" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P301"]),
                float(48.4113693),
            )
        if "P302" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P302"]),
                float(48.6494293),
            )
        if "P303" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P303"]),
                float(49.0014572),
            )
        if "P304" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P304"]),
                float(48.6789932),
            )
        if "P305" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P305"]),
                float(47.3707924),
            )
        if "P306" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P306"]),
                float(47.2600479),
            )
        if "P307" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P307"]),
                float(46.5539703),
            )
        if "P308" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P308"]),
                float(46.2514153),
            )
        if "P309" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P309"]),
                float(45.8382378),
            )
        if "P401" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P401"]),
                float(49.1842041),
            )
        if "P402" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P402"]),
                float(46.2833633),
            )
        if "P403" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P403"]),
                float(49.4383583),
            )
        if "P404" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P404"]),
                float(49.8198280),
            )
        if "P405" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P405"]),
                float(47.8698006),
            )
        if "P406" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P406"]),
                float(46.3379631),
            )
        if "P407" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P407"]),
                float(47.7081528),
            )
        if "P501" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P501"]),
                float(46.5787659),
            )
        if "P502" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P502"]),
                float(47.3301430),
            )
        if "P503" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P503"]),
                float(46.5575447),
            )
        if "P504" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P504"]),
                float(46.4538345),
            )
        if "P505" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P505"]),
                float(46.0914383),
            )
        if "P506" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P506"]),
                float(46.1212387),
            )
        if "P507" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P507"]),
                float(45.4262505),
            )
        if "P508" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P508"]),
                float(47.4120369),
            )
        if "P509" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P509"]),
                float(44.7292328),
            )
        if "P510" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P510"]),
                float(47.9998589),
            )
        if "P511" in ix_:
            ...
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["P511"]),
                float(45.7520485),
            )
        if "Q1" in ix_:
            self.x0[ix_["Q1"]] = float(0.192685e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q1"]),
                float(0.192685e03),
            )
        if "Q2" in ix_:
            self.x0[ix_["Q2"]] = float(0.185378e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q2"]),
                float(0.185378e03),
            )
        if "Q3" in ix_:
            self.x0[ix_["Q3"]] = float(0.182942e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q3"]),
                float(0.182942e03),
            )
        if "Q4" in ix_:
            self.x0[ix_["Q4"]] = float(0.179289e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q4"]),
                float(0.179289e03),
            )
        if "Q5" in ix_:
            self.x0[ix_["Q5"]] = float(0.119560e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q5"]),
                float(0.119560e03),
            )
        if "Q6" in ix_:
            self.x0[ix_["Q6"]] = float(0.548582e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q6"]),
                float(0.548582e02),
            )
        if "Q7" in ix_:
            self.x0[ix_["Q7"]] = float(0.194484e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q7"]),
                float(0.194484e02),
            )
        if "Q8" in ix_:
            self.x0[ix_["Q8"]] = float(0.928046e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q8"]),
                float(0.928046e02),
            )
        if "Q9" in ix_:
            self.x0[ix_["Q9"]] = float(0.727037e01)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q9"]),
                float(0.727037e01),
            )
        if "Q10" in ix_:
            self.x0[ix_["Q10"]] = float(0.804928e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q10"]),
                float(0.804928e02),
            )
        if "Q11" in ix_:
            self.x0[ix_["Q11"]] = float(-0.878354e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q11"]),
                float(-0.878354e02),
            )
        if "Q12" in ix_:
            self.x0[ix_["Q12"]] = float(0.744038e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q12"]),
                float(0.744038e02),
            )
        if "Q13" in ix_:
            self.x0[ix_["Q13"]] = float(0.414030e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q13"]),
                float(0.414030e02),
            )
        if "Q14" in ix_:
            self.x0[ix_["Q14"]] = float(0.232588e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q14"]),
                float(0.232588e02),
            )
        if "Q15" in ix_:
            self.x0[ix_["Q15"]] = float(0.280080e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q15"]),
                float(0.280080e02),
            )
        if "Q16" in ix_:
            self.x0[ix_["Q16"]] = float(0.194840e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q16"]),
                float(0.194840e02),
            )
        if "Q17" in ix_:
            self.x0[ix_["Q17"]] = float(0.256322e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q17"]),
                float(0.256322e02),
            )
        if "Q18" in ix_:
            self.x0[ix_["Q18"]] = float(-0.499872e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q18"]),
                float(-0.499872e02),
            )
        if "Q19" in ix_:
            self.x0[ix_["Q19"]] = float(0.158902e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q19"]),
                float(0.158902e02),
            )
        if "Q20" in ix_:
            self.x0[ix_["Q20"]] = float(0.330600e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q20"]),
                float(0.330600e02),
            )
        if "Q21" in ix_:
            self.x0[ix_["Q21"]] = float(0.269710e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q21"]),
                float(0.269710e02),
            )
        if "Q22" in ix_:
            self.x0[ix_["Q22"]] = float(-0.146130e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q22"]),
                float(-0.146130e02),
            )
        if "Q23" in ix_:
            self.x0[ix_["Q23"]] = float(0.785198e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q23"]),
                float(0.785198e03),
            )
        if "Q24" in ix_:
            self.x0[ix_["Q24"]] = float(-0.963594e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q24"]),
                float(-0.963594e02),
            )
        if "Q25" in ix_:
            self.x0[ix_["Q25"]] = float(0.959108e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q25"]),
                float(0.959108e03),
            )
        if "Q26" in ix_:
            self.x0[ix_["Q26"]] = float(0.952108e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q26"]),
                float(0.952108e03),
            )
        if "Q27" in ix_:
            self.x0[ix_["Q27"]] = float(0.896108e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q27"]),
                float(0.896108e03),
            )
        if "Q28" in ix_:
            self.x0[ix_["Q28"]] = float(0.210000e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q28"]),
                float(0.210000e02),
            )
        if "Q29" in ix_:
            self.x0[ix_["Q29"]] = float(0.778108e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q29"]),
                float(0.778108e03),
            )
        if "Q30" in ix_:
            self.x0[ix_["Q30"]] = float(0.560000e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q30"]),
                float(0.560000e02),
            )
        if "Q31" in ix_:
            self.x0[ix_["Q31"]] = float(0.705999e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q31"]),
                float(0.705999e03),
            )
        if "Q32" in ix_:
            self.x0[ix_["Q32"]] = float(0.311093e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q32"]),
                float(0.311093e02),
            )
        if "Q33" in ix_:
            self.x0[ix_["Q33"]] = float(0.604474e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q33"]),
                float(0.604474e03),
            )
        if "Q34" in ix_:
            self.x0[ix_["Q34"]] = float(0.575246e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q34"]),
                float(0.575246e02),
            )
        if "Q35" in ix_:
            self.x0[ix_["Q35"]] = float(0.592474e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q35"]),
                float(0.592474e03),
            )
        if "Q36" in ix_:
            self.x0[ix_["Q36"]] = float(-0.452460e01)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q36"]),
                float(-0.452460e01),
            )
        if "Q37" in ix_:
            self.x0[ix_["Q37"]] = float(-0.234754e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q37"]),
                float(-0.234754e02),
            )
        if "Q38" in ix_:
            self.x0[ix_["Q38"]] = float(0.310933e01)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q38"]),
                float(0.310933e01),
            )
        if "Q39" in ix_:
            self.x0[ix_["Q39"]] = float(0.395173e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q39"]),
                float(0.395173e03),
            )
        if "Q40" in ix_:
            self.x0[ix_["Q40"]] = float(0.176301e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q40"]),
                float(0.176301e03),
            )
        if "Q41" in ix_:
            self.x0[ix_["Q41"]] = float(0.144907e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q41"]),
                float(0.144907e03),
            )
        if "Q42" in ix_:
            self.x0[ix_["Q42"]] = float(0.209265e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q42"]),
                float(0.209265e03),
            )
        if "Q43" in ix_:
            self.x0[ix_["Q43"]] = float(0.213451e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q43"]),
                float(0.213451e02),
            )
        if "Q44" in ix_:
            self.x0[ix_["Q44"]] = float(0.845622e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q44"]),
                float(0.845622e02),
            )
        if "Q45" in ix_:
            self.x0[ix_["Q45"]] = float(-0.886488e01)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q45"]),
                float(-0.886488e01),
            )
        if "Q46" in ix_:
            self.x0[ix_["Q46"]] = float(-0.117900e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q46"]),
                float(-0.117900e02),
            )
        if "Q47" in ix_:
            self.x0[ix_["Q47"]] = float(-0.548649e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q47"]),
                float(-0.548649e02),
            )
        if "Q48" in ix_:
            self.x0[ix_["Q48"]] = float(0.160000e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q48"]),
                float(0.160000e02),
            )
        if "Q49" in ix_:
            self.x0[ix_["Q49"]] = float(-0.808649e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q49"]),
                float(-0.808649e02),
            )
        if "Q50" in ix_:
            self.x0[ix_["Q50"]] = float(0.210000e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q50"]),
                float(0.210000e02),
            )
        if "Q51" in ix_:
            self.x0[ix_["Q51"]] = float(-0.767900e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q51"]),
                float(-0.767900e02),
            )
        if "Q52" in ix_:
            self.x0[ix_["Q52"]] = float(-0.155265e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q52"]),
                float(-0.155265e03),
            )
        if "Q53" in ix_:
            self.x0[ix_["Q53"]] = float(0.190000e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q53"]),
                float(0.190000e02),
            )
        if "Q54" in ix_:
            self.x0[ix_["Q54"]] = float(-0.638913e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q54"]),
                float(-0.638913e02),
            )
        if "Q55" in ix_:
            self.x0[ix_["Q55"]] = float(-0.769736e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q55"]),
                float(-0.769736e02),
            )
        if "Q56" in ix_:
            self.x0[ix_["Q56"]] = float(-0.297006e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q56"]),
                float(-0.297006e03),
            )
        if "Q57" in ix_:
            self.x0[ix_["Q57"]] = float(0.155115e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q57"]),
                float(0.155115e03),
            )
        if "Q58" in ix_:
            self.x0[ix_["Q58"]] = float(-0.322006e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q58"]),
                float(-0.322006e03),
            )
        if "Q59" in ix_:
            self.x0[ix_["Q59"]] = float(0.741150e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q59"]),
                float(0.741150e02),
            )
        if "Q60" in ix_:
            self.x0[ix_["Q60"]] = float(0.210000e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q60"]),
                float(0.210000e02),
            )
        if "Q61" in ix_:
            self.x0[ix_["Q61"]] = float(0.181150e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q61"]),
                float(0.181150e02),
            )
        if "Q62" in ix_:
            self.x0[ix_["Q62"]] = float(0.210000e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q62"]),
                float(0.210000e02),
            )
        if "Q63" in ix_:
            self.x0[ix_["Q63"]] = float(-0.884952e00)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q63"]),
                float(-0.884952e00),
            )
        if "Q64" in ix_:
            self.x0[ix_["Q64"]] = float(0.320000e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q64"]),
                float(0.320000e02),
            )
        if "Q65" in ix_:
            self.x0[ix_["Q65"]] = float(-0.407006e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q65"]),
                float(-0.407006e03),
            )
        if "Q66" in ix_:
            self.x0[ix_["Q66"]] = float(-0.666918e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q66"]),
                float(-0.666918e03),
            )
        if "Q67" in ix_:
            self.x0[ix_["Q67"]] = float(0.165912e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q67"]),
                float(0.165912e03),
            )
        if "Q68" in ix_:
            self.x0[ix_["Q68"]] = float(0.210000e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q68"]),
                float(0.210000e02),
            )
        if "Q69" in ix_:
            self.x0[ix_["Q69"]] = float(0.569121e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q69"]),
                float(0.569121e02),
            )
        if "Q70" in ix_:
            self.x0[ix_["Q70"]] = float(0.199121e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q70"]),
                float(0.199121e02),
            )
        if "Q71" in ix_:
            self.x0[ix_["Q71"]] = float(-0.306772e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q71"]),
                float(-0.306772e02),
            )
        if "Q72" in ix_:
            self.x0[ix_["Q72"]] = float(0.155893e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q72"]),
                float(0.155893e02),
            )
        if "Q73" in ix_:
            self.x0[ix_["Q73"]] = float(0.218850e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q73"]),
                float(0.218850e02),
            )
        if "Q74" in ix_:
            self.x0[ix_["Q74"]] = float(0.700000e01)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q74"]),
                float(0.700000e01),
            )
        if "Q75" in ix_:
            self.x0[ix_["Q75"]] = float(-0.241070e01)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q75"]),
                float(-0.241070e01),
            )
        if "Q76" in ix_:
            self.x0[ix_["Q76"]] = float(0.140000e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q76"]),
                float(0.140000e02),
            )
        if "Q77" in ix_:
            self.x0[ix_["Q77"]] = float(-0.464107e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q77"]),
                float(-0.464107e02),
            )
        if "Q78" in ix_:
            self.x0[ix_["Q78"]] = float(0.268907e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q78"]),
                float(0.268907e02),
            )
        if "Q79" in ix_:
            self.x0[ix_["Q79"]] = float(-0.119301e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q79"]),
                float(-0.119301e03),
            )
        if "Q80" in ix_:
            self.x0[ix_["Q80"]] = float(0.230000e02)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["Q80"]),
                float(0.230000e02),
            )
        if "S1" in ix_:
            self.x0[ix_["S1"]] = float(0.192685e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["S1"]),
                float(0.192685e03),
            )
        if "S23" in ix_:
            self.x0[ix_["S23"]] = float(0.785198e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["S23"]),
                float(0.785198e03),
            )
        if "S101" in ix_:
            self.x0[ix_["S101"]] = float(0.959108e03)
        else:
            self.y0 = arrset(
                self.y0,
                findfirst(self.congrps, lambda x: x == ig_["S101"]),
                float(0.959108e03),
            )
        # %%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_ = {}
        ...
        loaset(self.elpar, ie, posep[0], float(1.37621e02))
        ename = "PANH2"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eSQUARE")
        ...
        posep = np.where(elftp[ielftype[ie]] == "A2")[0]
        loaset(self.elpar, ie, posep[0], float(1.94163e02))
        ename = "PANH6"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eSQUARE")
        ...
        posep = np.where(elftp[ielftype[ie]] == "A2")[0]
        loaset(self.elpar, ie, posep[0], float(4.92083e02))
        ename = "PANH10"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eSQUARE")
        ...
        posep = np.where(elftp[ielftype[ie]] == "A2")[0]
        loaset(self.elpar, ie, posep[0], float(3.43580e02))
        ename = "PANH13"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eSQUARE")
        ...
        posep = np.where(elftp[ielftype[ie]] == "A2")[0]
        loaset(self.elpar, ie, posep[0], float(9.63346e01))
        ename = "PANH24"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eSQUARE")
        ...
        posep = np.where(elftp[ielftype[ie]] == "A2")[0]
        loaset(self.elpar, ie, posep[0], float(8.60722e01))
        ename = "PANH26"
        [ie, ie_, newelt] = s2mpj_ii(ename, ie_)
        if newelt:
            self.elftype = arrset(self.elftype, ie, "eSQUARE")
    ...
    def e_globs(self):
        ...
        self.efpar = arrset(self.efpar, 3, 3.5657e0)
        self.efpar = arrset(self.efpar, 4, 1.47519e1)
        self.efpar = arrset(self.efpar, 5, 1.0e-1)
        self.efpar = arrset(self.efpar, 6, np.log10(np.exp(1.0e0)))
        return pbm
    ...
    def eSQUARE(self, nargout, *args):
        ...
        if nargout > 1:
            try:
                ...
                dim = len(EV_)
            g_ = np.zeros(dim)
            g_[0] = 2.0e0 * self.efpar[0] * (self.efpar[0] * EV_[0] + self.efpar[1])
            if nargout > 2:
                H_ = np.zeros((1, 1))
                H_[0, 0] = 2.0e0 * self.efpar[0] * self.efpar[0]
        if nargout == 1:
            return f_
        elif nargout == 2:
            return f_, g_
    ...
    def ePANHAN(self, nargout, *args):
        ...
        if QLE != 0:
            H1 = -1.0e0
        if QELSE != 0:
            H1 = 1.5e0 * QRATIO - 5.0e-1 * QRATIO**3
        if QGE != 0:
            H2 = 0.0e0
        if QLE != 0:
            H2 = 0.0e0
        if QELSE != 0:
            H2 = (1.5e0 - 1.5e0 * QRATIO**2) / self.efpar[5]
        ARGLOG = self.elpar[iel_][1] * H
        X = np.log10(ARGLOG) - 5.0e0
        ...
        F2 = (
            -2.0
            * FROOT**3
            * (DERIV * X2 + 2.0 * self.efpar[2] * X1**2 - 0.75 * F1**2 / FROOT**5)
        )
        ...
        if nargout > 1:
            ...
            if nargout > 2:
                H_ = np.zeros((1, 1))
                H_[0, 0] = self.elpar[iel_][0] * (
                    2.0 * (F1 * H + F * H1) + EV_[0] * (F2 * H + 2.0 * F1 * H1 + F * H2)
                )
        if nargout == 1:
            return f_
        elif nargout == 2:
