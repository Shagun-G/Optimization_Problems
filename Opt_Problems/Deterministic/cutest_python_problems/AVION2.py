...
class AVION2(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        self.x0[ix_["SR"]] = float(2.7452e01)
        self.x0[ix_["LR"]] = float(1.5000)
        self.x0[ix_["PK"]] = float(1.0000e01)
        self.x0[ix_["EF"]] = float(0.0000)
        self.x0[ix_["SX"]] = float(1.9217e01)
        self.x0[ix_["LX"]] = float(1.5000)
        self.x0[ix_["SD"]] = float(3.5688)
        self.x0[ix_["SK"]] = float(4.0696)
        self.x0[ix_["ST"]] = float(3.4315e01)
        self.x0[ix_["SF"]] = float(8.8025e01)
        ...
        self.x0[ix_["IMPDER"]] = float(1.1470e02)
        self.x0[ix_["IMPK"]] = float(5.0000e02)
        self.x0[ix_["IMPFUS"]] = float(1.7605e03)
        self.x0[ix_["QI"]] = float(2.3256e03)
        self.x0[ix_["PT"]] = float(5.6788)
        self.x0[ix_["MV"]] = float(1.4197e04)
        self.x0[ix_["MC"]] = float(1.2589e04)
        self.x0[ix_["MD"]] = float(2.8394e04)
        self.x0[ix_["PD"]] = float(2.0000e-01)
        self.x0[ix_["NS"]] = float(1.0000)
        self.x0[ix_["VS"]] = float(0.0000)
        self.x0[ix_["CR"]] = float(1.0000e02)
        self.x0[ix_["PM"]] = float(1.5000e01)
        self.x0[ix_["DV"]] = float(0.0000)
        self.x0[ix_["MZ"]] = float(5.0000e02)
        self.x0[ix_["VN"]] = float(1.0000e01)
        self.x0[ix_["QV"]] = float(8.1490e02)
        self.x0[ix_["QF"]] = float(3.1405e03)
        self.x0[ix_["IMPTRAIN"]] = float(1.9450e03)
        self.x0[ix_["IMPMOT"]] = float(1.9085e02)
        self.x0[ix_["IMPNMOT"]] = float(3.5000e01)
        self.x0[ix_["IMPPET"]] = float(1.0000e02)
        self.x0[ix_["IMPPIL"]] = float(2.0000e02)
        self.x0[ix_["IMPCAN"]] = float(1.2000e02)
        self.x0[ix_["IMPSNA"]] = float(7.0000e02)
        self.x0[ix_["MS"]] = float(1.0000e03)
        self.x0[ix_["EL"]] = float(4.9367)
        self.x0[ix_["DE"]] = float(0.0000)
        self.x0[ix_["DS"]] = float(0.0000)
        self.x0[ix_["IMPVOIL"]] = float(5.0000e03)
    ...
    def eCBdSQQD(self, nargout, *args):
        ...
        if nargout > 1:
            ...
            if nargout > 2:
                ...
                H_[3, 1] = H_[1, 3]
                H_[2, 2] = (
                    -6.0e0 * EV_[1] * EV_[2] / SQQD
                    + (3.0e0 * EV_[1] * EV_[2] ** 2 * DYSQQD) / SQQD**2
                    + (2.0e0 * CB * DYSQQD**2) / SQQD**3
                    - (6.0e0 * CB * (1.0 - EV_[3] * EV_[2])) / SQQD**2
                )
                H_[2, 3] = (
                    -(3.0e0 * EV_[1] * EV_[2]) / TMZY**2
                    - (6.0e0 * EV_[2] ** 4 * (TMZY - 1.0e0) * CB) / SQQD**3
                    + 3.0e0 * CB * EV_[2] ** 2 / SQQD**2
                )
                H_[3, 2] = H_[2, 3]
    ...
    def eSREL(self, nargout, *args):
        ...
        if nargout > 1:
            ...
            if nargout > 2:
                ...
                H_[1, 2] = SRVLN * (
                    (0.75e0 * SRPD) / (SRQD**2 * SRRT) + (1.5e0 * SRRT) / SRQD
                )
                H_[2, 1] = H_[1, 2]
