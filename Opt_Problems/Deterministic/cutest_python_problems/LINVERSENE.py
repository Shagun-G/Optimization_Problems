...
class LINVERSENE(CUTEst_problem):
    ...
    def __init__(self, *args):
        ...
        v_["T" + str(int(v_["N-1"])) + "," + str(int(v_["N-1"]))] = (
            v_["SINI"] * v_["COSJ"]
        )
        v_["RN"] = float(v_["N"])
        v_["SINI"] = np.sin(v_["RN"])
        v_["T" + str(int(v_["N"])) + "," + str(int(v_["N-1"]))] = (
            v_["SINI"] * v_["COSJ"]
        )
        ...
        for J in range(int(v_["1"]), int(v_["N-2"]) + 1):
            ...
            self.gscale = arrset(self.gscale, ig, float(v_["ROOTP5"]))
        [ig, ig_, _] = s2mpj_ii(
            "O" + str(int(v_["N-1"])) + "," + str(int(v_["N-1"])), ig_
        )
        gtype = arrset(gtype, ig, "==")
        cnames = arrset(
            cnames, ig, "O" + str(int(v_["N-1"])) + "," + str(int(v_["N-1"]))
        )
        [ig, ig_, _] = s2mpj_ii(
            "O" + str(int(v_["N"])) + "," + str(int(v_["N-1"])), ig_
        )
        gtype = arrset(gtype, ig, "==")
        ...
        for I in range(int(v_["1"]), int(v_["N"]) + 1):
            self.gconst = arrset(
                self.gconst, ig_["O" + str(I) + "," + str(I)], float(1.0)
            )
        # %%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        self.grelt = loaset(
            ...
            ig,
            posel,
            ie_["S" + str(int(v_["1"])) + "," + str(int(v_["1"]))],
        )
        ...
        self.grelw = loaset(
            ...
            ig,
            posel,
            float(v_["T" + str(int(v_["1"])) + "," + str(int(v_["1"]))]),
        )
        ...
        self.grelt = loaset(
            ...
            ig,
            posel,
            ie_["S" + str(int(v_["2"])) + "," + str(int(v_["1"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
            ig,
            posel,
            float(v_["T" + str(int(v_["2"])) + "," + str(int(v_["1"]))]),
        )
        posel = len(self.grelt[ig])
        self.grelt = loaset(
            self.grelt,
            ig,
            posel,
            ie_["V" + str(int(v_["2"])) + "," + str(int(v_["1"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
        ...
        self.grelt = loaset(
            ...
            ig,
            posel,
            ie_["S" + str(int(v_["3"])) + "," + str(int(v_["1"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
            ig,
            posel,
            float(v_["T" + str(int(v_["3"])) + "," + str(int(v_["1"]))]),
        )
        posel = len(self.grelt[ig])
        self.grelt = loaset(
            self.grelt,
            ig,
            posel,
            ie_["V" + str(int(v_["3"])) + "," + str(int(v_["1"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
        ...
        self.grelt = loaset(
            ...
            ig,
            posel,
            ie_["S" + str(int(v_["2"])) + "," + str(int(v_["2"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
            ig,
            posel,
            float(v_["T" + str(int(v_["2"])) + "," + str(int(v_["2"]))]),
        )
        posel = len(self.grelt[ig])
        self.grelt = loaset(
            self.grelt,
            ig,
            posel,
            ie_["U" + str(int(v_["2"])) + "," + str(int(v_["2"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
        ...
        self.grelt = loaset(
            ...
            ig,
            posel,
            ie_["V" + str(int(v_["2"])) + "," + str(int(v_["2"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
        ...
        self.grelt = loaset(
            ...
            ig,
            posel,
            ie_["W" + str(int(v_["2"])) + "," + str(int(v_["2"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
        ...
        self.grelt = loaset(
            ...
            ig,
            posel,
            ie_["S" + str(int(v_["3"])) + "," + str(int(v_["2"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
            ig,
            posel,
            float(v_["T" + str(int(v_["3"])) + "," + str(int(v_["2"]))]),
        )
        posel = len(self.grelt[ig])
        self.grelt = loaset(
            self.grelt,
            ig,
            posel,
            ie_["U" + str(int(v_["3"])) + "," + str(int(v_["2"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
        ...
        self.grelt = loaset(
            ...
            ig,
            posel,
            ie_["V" + str(int(v_["3"])) + "," + str(int(v_["2"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
        ...
        self.grelt = loaset(
            ...
            ig,
            posel,
            ie_["W" + str(int(v_["3"])) + "," + str(int(v_["2"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
        ...
        self.grelt = loaset(
            ...
            ig,
            posel,
            ie_["S" + str(int(v_["3"])) + "," + str(int(v_["3"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
            ig,
            posel,
            float(v_["T" + str(int(v_["3"])) + "," + str(int(v_["3"]))]),
        )
        posel = len(self.grelt[ig])
        self.grelt = loaset(
            self.grelt,
            ig,
            posel,
            ie_["U" + str(int(v_["3"])) + "," + str(int(v_["3"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
        ...
        self.grelt = loaset(
            ...
            ig,
            posel,
            ie_["V" + str(int(v_["3"])) + "," + str(int(v_["3"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
        ...
        self.grelt = loaset(
            ...
            ig,
            posel,
            ie_["W" + str(int(v_["3"])) + "," + str(int(v_["3"]))],
        )
        nlc = np.union1d(nlc, np.array([ig]))
        self.grelw = loaset(
            self.grelw,
        ...
        for I in range(int(v_["4"]), int(v_["N"]) + 1):
            ...
            posel = len(self.grelt[ig])
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["S" + str(I) + "," + str(int(v_["I-2"]))]
            )
            nlc = np.union1d(nlc, np.array([ig]))
            self.grelw = loaset(
                self.grelw,
                ig,
                posel,
                float(v_["T" + str(I) + "," + str(int(v_["I-2"]))]),
            )
            posel = len(self.grelt[ig])
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["V" + str(I) + "," + str(int(v_["I-2"]))]
            )
            nlc = np.union1d(nlc, np.array([ig]))
            self.grelw = loaset(
                self.grelw,
                ig,
                posel,
                float(v_["T" + str(int(v_["I-1"])) + "," + str(int(v_["I-2"]))]),
            )
            ig = ig_["O" + str(I) + "," + str(int(v_["I-1"]))]
            posel = len(self.grelt[ig])
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["S" + str(I) + "," + str(int(v_["I-1"]))]
            )
            nlc = np.union1d(nlc, np.array([ig]))
            self.grelw = loaset(
                self.grelw,
                ig,
                posel,
                float(v_["T" + str(I) + "," + str(int(v_["I-1"]))]),
            )
            posel = len(self.grelt[ig])
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["U" + str(I) + "," + str(int(v_["I-1"]))]
            )
            nlc = np.union1d(nlc, np.array([ig]))
            self.grelw = loaset(
                self.grelw,
            ...
            posel = len(self.grelt[ig])
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["V" + str(I) + "," + str(int(v_["I-1"]))]
            )
            nlc = np.union1d(nlc, np.array([ig]))
            self.grelw = loaset(
                self.grelw,
                ig,
                posel,
                float(v_["T" + str(int(v_["I-1"])) + "," + str(int(v_["I-1"]))]),
            )
            posel = len(self.grelt[ig])
            self.grelt = loaset(
                self.grelt, ig, posel, ie_["W" + str(I) + "," + str(int(v_["I-1"]))]
            )
            nlc = np.union1d(nlc, np.array([ig]))
            self.grelw = loaset(
                self.grelw,
            ...
            nlc = np.union1d(nlc, np.array([ig]))
            self.grelw = loaset(
                self.grelw, ig, posel, float(v_["T" + str(I) + "," + str(I)])
            )
            posel = len(self.grelt[ig])
