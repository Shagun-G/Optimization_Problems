...
class Quadratic_linear_norm_constraints(Problem):
    ...
    def __init__(
        self, d: int, n_quadratics: int, seed: int | None = None, xi: int = 2, m : int = 10, b_2 : float = 1) -> None:

        self.objective_function = Quadratic(d = d, n_quadratics=n_quadratics, seed=seed, xi=xi)

        super().__init__(name=f"{self.objective_function.name}_linear_norm_constraint", d=self.objective_function.d, number_of_datapoints=n_quadratics, eq_const_number=m+1, ineq_const_number=0)
...
class Quadratic_linear_constraints(Problem):
    ...
    def __init__(
        self, d: int, n_quadratics: int, seed: int | None = None, xi: int = 2, m : int = 10) -> None:
...
class Quadratic_norm_constraints(Problem):
    ...
    def __init__(
        self, d: int, n_quadratics: int, seed: int | None = None, xi: int = 2, b_2 : float = 1) -> None:
