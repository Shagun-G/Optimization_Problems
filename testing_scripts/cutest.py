...
# 
problem = CUTESTStochastic(name=name, noise_option=CUTESTNoiseOptions.UniformNoiseInitialPoint, noise_level=1)
"""Calling all functions"""
# print("Name: " + problem.name)
# print("Dimension : ", problem.d)
# print("At x = ", problem.initial_point())
...
print("Function: ", problem.objective(x=problem.initial_point(), type=StochasticApproximationType.MiniBatch, batch_size=10, seed=101))
